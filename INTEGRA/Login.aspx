<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Login.aspx.vb" Inherits="Integra.Login" %>
...
<head id="Head1" runat="server">
    ...
    <title>GARA TEX- Login Page</title>
...
<body id="newLoginPage" onload="MM_preloadImages('images/button-tabs/btn_h.png')">
    ...
    <img src="images/layout/ECPlogo.jpg" alt="SoftLayer(R)" id="login-logo" />
