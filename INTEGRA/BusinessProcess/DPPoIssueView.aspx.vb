        ...
        Try
            Select Case e.CommandName
                Case Is = "EDIT"
                    ...
                    Dim lDPPOIssueMstID As String = item("DPPOIssueMstID").Text
                    Response.Redirect("FabricIssueToDept.aspx?lDPPOIssueMstID=" & lDPPOIssueMstID & "")
                Case Is = "PDF"
                    Dim item As GridDataItem = DirectCast(e.Item, GridDataItem)
                    Dim lDPPOIssueMstID As String = item("DPPOIssueMstID").Text
                    ...
                    di.Create()
                    Dim FileName As String = "PO Receive Report"
                    Dim sTempFileName As String = Request.PhysicalApplicationPath + "/TempPDF/" & FileName & ".pdf"
                    Report.SetParameterValue(0, lDPPOIssueMstID)
                ...
                Case Is = "Delete"
                    Dim item As GridDataItem = DirectCast(e.Item, GridDataItem)
                    Dim lDPPOIssueMstID As String = item("DPPOIssueMstID").Text
                    OBJPOMST.DeletedForPOIssueMst(lDPPOIssueMstID)
                    OBJPOMST.DeletedForPOIssueDtl(lDPPOIssueMstID)
                        objDataView = LoadData()
                        Session("objDataView") = objDataView
                        BindGrid()
