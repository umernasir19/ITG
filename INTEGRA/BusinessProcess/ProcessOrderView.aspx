<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master"
    CodeBehind="ProcessOrderView.aspx.vb" Inherits="Integra.ProcessOrderView" %>
...
<table>
  <tr style="border-bottom-style: solid; border-bottom-color: #00509F; border-bottom-width: thin;"
            ...
            <th colspan="6" align="left" style="font-family:Century Gothic ; font-size: 16PX; font-weight: bold;
                color:Blue ">
             <marquee >Searching Criteria For Process No,Supplier</marquee>
            </th>
        </tr>
</table>
<br />
   <table>
        <tr>
            ...
            <td style="width: 150px;">
                <asp:TextBox ID="txtSummarySearch" runat="server" AutoPostBack="true" autocomplete="off"
                    Width="196px" ToolTip="Item Name" Visible ="true"  Style="margin-left: 12px;"> </asp:TextBox>
                <cc1:AutoCompleteExtender runat="server" ID="AutoCompleteExtender1" TargetControlID="txtSummarySearch"
                    ServicePath="../AutoComplete.asmx" ServiceMethod="GetCompletionList" MinimumPrefixLength="1"
                    CompletionInterval="10" EnableCaching="true" CompletionSetCount="12" ContextKey="GetProcessEntrySearching" />
            </td>
            <td>
            ...
            <td>
                <asp:Button ID="btnSummaryShowAll" Visible ="false"  runat="server" CssClass="button" Text="Show All"
                    Width="80"></asp:Button>
            </td>
        </tr>
    </table>
    <table width="100%">
        <tr>
            ...
            <td>
                <asp:Button ID="cmdAdd" runat="server" CssClass="button" Text="ADD PROCESS ORDER"
        ...
        <tr>
            <td>
                <Smart:SmartDataGrid ID="dgSummaryView" runat="server" Width="100%" OnSortCommand="SortByColumnSummary"
                    ...
                    <Columns>
                        <asp:BoundColumn ItemStyle-HorizontalAlign="center" HeaderStyle-Width="5%" HeaderText="ProcessOrderMstID"
    ...
    <table width="100%">
        <tr>
            ...
            <td>
                <asp:Button ID="btnDetail" runat="server" Visible ="false"  CssClass="button" Text="Show Detail" Width="160"
