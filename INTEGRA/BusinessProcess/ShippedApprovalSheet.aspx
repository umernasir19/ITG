<%@ Page Language="vb" MasterPageFile="~/MasterPage.master"  AutoEventWireup="false" CodeBehind="ShippedApprovalSheet.aspx.vb" Inherits="Integra.ShippedApprovalSheet" %>
...
<div>
    <table width="100%">
        ...
        <asp:UpdatePanel ID="UpdatePanel3" UpdateMode="Conditional" runat="server">
               <ContentTemplate>
            <telerik:RadGrid ID="dgShippedApprovalSheet" runat="server" CellSpacing="0" 
                AutoGenerateColumns="False"  Skin="WebBlue" AllowFilteringByColumn ="True" 
                AllowPaging="True" GridLines="None" 
                ShowGroupPanel="false" PageSize="50" OnSortCommand="dgShippedApprovalSheet_SortCommand"
                 OnPageIndexChanged="dgShippedApprovalSheet_PageIndexChanged"
             ShowStatusBar="True" 
            ...
            <telerik:GridTemplateColumn  HeaderText="Action"  AllowFiltering ="false">
              <itemstyle horizontalalign="Center" />
               <HeaderStyle Width="5%" HorizontalAlign="Center" Font-Size="Smaller"/>
				<ITEMTEMPLATE>
   <asp:LinkButton ID="lnkApprove"  runat ="server" CommandName ="Approved"   Text="Okay to Ship" ></asp:LinkButton>
        </ITEMTEMPLATE>
   <headerstyle width="5%" />
