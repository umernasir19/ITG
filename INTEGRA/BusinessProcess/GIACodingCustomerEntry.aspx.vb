...
Public Class GIACodingCustomerEntry
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            PageHeader("Customer GIA Number Entry Panel")
            BindBuyerWise()
            BindSupplierWise()
        End If
    End Sub
    ...
    Public Sub SaveInSession()
        ...
        Else
            ...
            With dtLKZ
                With dtLKZ
                    .Columns.Add("GIACodingCustomerID", GetType(Long))
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Try
            Dim GIACodingCustomerID, SupplierID, CustomerID, LKZNumber As String
            Dim x As Integer
            Dim dtCheck As New DataTable
            If dgLKZz.Items.Count > 0 Then
                For x = 0 To dgLKZz.Items.Count - 1
                    GIACodingCustomerID = dgLKZz.Items(x).Cells(0).Text
                    ...
                    dtCheck = objGIACodingCustomer.CheckExistingOfLKZNumber(SupplierID, CustomerID)
                    If dtCheck.Rows.Count > 0 Then
                        'Not allow more than one entry
                        lblmsg.Visible = True
                    Else
                        With objGIACodingCustomer
                            .GIACodingCustomerID = GIACodingCustomerID
                            .SupplierID = SupplierID
                            .CustomerID = CustomerID
                            .GIANumber = LKZNumber
                            .SavGIACodingCustomer()

                        End With
                        Session("dtLKZ") = Nothing
                        Response.Redirect("GIACodingCustomerView.aspx")
                    End If
                Next
            Else
                'Not Save
