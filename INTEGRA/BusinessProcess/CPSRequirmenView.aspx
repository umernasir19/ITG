<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="CPSRequirmenView.aspx.vb" Inherits="Integra.CPSRequirmenView" %>
...
<table width="100%">
        <tr style ="height :34px;">
          ...
          <tr >
            <td>
                <Smart:SmartDataGrid ID="dgCPSRequirment" runat="server" Width="100%" OnSortCommand="SortByColumn"
                    ...
                    <Columns>
                        <asp:BoundColumn ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="5%" HeaderText="CPRequirmentId"
                            DataField="CPRequirmentId" Visible="false">
                            <HeaderStyle Width="10%" HorizontalAlign="Left" />
                        </asp:BoundColumn>
                        <asp:BoundColumn ItemStyle-HorizontalAlign="center" HeaderStyle-Width="10%" HeaderText="Requirment"
                            DataField="CPRequirmen">
                       ...
                       <ASP:TEMPLATECOLUMN HeaderText="Edit" Visible ="true" >
									...
									<ITEMTEMPLATE>
<asp:HyperLink id="lnkEdit" Runat="server" NavigateUrl='<%# "CPSRequirmenEntry.aspx?lCPRequirmentId=" &amp; DataBinder.Eval(Container.DataItem,"CPRequirmentId")%>' Enabled="true">
											Edit
										</asp:HyperLink> 
</ITEMTEMPLATE>
