<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="BuyerComment.aspx.vb" Inherits="Integra.BuyerComment" %>
    ...
    <table width="100%">
        <tr>
         ...
         <tr>
            ...
            <td style="width: 110px;">
              <asp:TextBox ID="txtDcdNo" runat="server" autocomplete="off" AutoPostBack="true"
                                    ...
                                    <cc1:AutoCompleteExtender ID="autoComplete1" runat="server" CompletionInterval="10"
                                        CompletionSetCount="12" ContextKey="SearchDCDNo" EnableCaching="true" MinimumPrefixLength="1"
                                        ServiceMethod="GetCompletionList" ServicePath="~/AutoComplete.asmx" TargetControlID="txtDcdNo" />
            <asp:Label ID="lblCourierMstID" runat="server"  Visible="false"></asp:Label>
                    </td> 
                     <td style="width: 110px;">
              Buyer Comment Date
               </td> 
            <td style="width: 110px;">
                <telerik:RadDatePicker ID="txtBuyerCommentDate" runat="server" Culture="en-US" Width="100px">
        ...
        <tr>
           ...
           <td style="width: 110px;">
                <telerik:RadTextBox ID="txtCourAirBillNo" runat="server" Skin="WebBlue" Width="105px" Visible="true"  >
                </telerik:RadTextBox>
        ...
        <tr>
          ...
          <td style="width: 110px;">
                <telerik:RadTextBox ID="txtAddress" runat="server" Skin="WebBlue" Width="379px" Visible="true" TextMode="MultiLine" >
                </telerik:RadTextBox>
      ...
      <%--    <tr>
         ...
         <tr>
           ...
           <td style="width: 110px;">
                <telerik:RadTextBox ID="txtDesc" runat="server" Skin="WebBlue" Width="105px" Visible="true"  >
                </telerik:RadTextBox>
        ...
        <tr>  
            ...
            <td class="TopHeaderTable3" style="width: 166px; height: 30px;">
                <telerik:RadButton ID="btnAdd" runat="server" Text="Add" Skin="WebBlue">
                </telerik:RadButton>
            </td>
        </tr>--%>
    </table><br />
                ...
                <telerik:RadGrid ID="dgCourier" runat="server" CellSpacing="0" AutoGenerateColumns="false"
                    ...
                    <MasterTableView>
                        <Columns>
                            ...
                            <telerik:GridBoundColumn HeaderText="Delivery Date" DataField="deliverDate"  Display="true">
                                <ItemStyle HorizontalAlign="Left" />
                                <HeaderStyle Width="15%" HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
                                                  
                        
                            <telerik:GridBoundColumn HeaderText="Converging Rate" DataField="ConvergeRate" Display="true">
                                <ItemStyle HorizontalAlign="Left" />
                                <HeaderStyle Width="15%" HorizontalAlign="Left" />
                            </telerik:GridBoundColumn>
