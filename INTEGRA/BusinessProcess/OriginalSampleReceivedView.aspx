<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="OriginalSampleReceivedView.aspx.vb" Inherits="Integra.OriginalSampleReceivedView" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  <table width="100%">
        <tr style="height: 34px;">
            ...
            <td align="right">
                <asp:Button ID="btnAdd" runat="server" CssClass="button" Text="Add Original Sample Received"
                    ...
                    <Columns>
                     ...
                     <asp:BoundColumn ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="5%" HeaderText="SamplingMasterID"
                        ...
                        <asp:TemplateColumn ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="10%" HeaderText="Action">
                            <ItemTemplate>
                                <asp:HyperLink ID="lnkEdit" Enabled="true" NavigateUrl='<%# "OriginalSampleReceived.aspx?SamplingMasterID=" &amp; DataBinder.Eval(Container.DataItem,"SamplingMasterID")%>'
                                    runat="server">
											View
                                </asp:HyperLink>
                                <br />
