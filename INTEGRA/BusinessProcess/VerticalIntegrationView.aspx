<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="VerticalIntegrationView.aspx.vb" Inherits="Integra.VerticalIntegrationView" %>
...
<table width="100%">
        <tr>
            <td align="right">
                <asp:Button ID="btnAdd" runat="server" CssClass="button" Text="Add VerticalIntegration." Width="180">
                </asp:Button>
            </td>
        </tr>
        <tr>
            <td>
                <Smart:SmartDataGrid ID="dgPurchaseOrder" runat="server" Width="100%" OnSortCommand="SortByColumn"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn ItemStyle-HorizontalAlign="center" HeaderStyle-Width="10%" HeaderText="Vertical Integration."
                            DataField="Name">
                       ...
                       <ASP:TEMPLATECOLUMN HeaderText="Edit" Visible ="true" >
									...
									<ITEMTEMPLATE>
<asp:HyperLink id="lnkEdit" Runat="server" NavigateUrl='<%# "VerticalIntegrationEntry.aspx?VVIID=" &amp; DataBinder.Eval(Container.DataItem,"VVIID")%>' Enabled="true">
											Edit
										</asp:HyperLink> 
</ITEMTEMPLATE>
