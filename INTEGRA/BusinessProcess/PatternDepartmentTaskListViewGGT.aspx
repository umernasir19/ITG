<%@ Page Title="Pattern Department Task List View" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="PatternDepartmentTaskListViewGGT.aspx.vb" Inherits="Integra.PatternDepartmentTaskListViewGGT" %>
   ...
   <table>
       <tr style="border-bottom-style: solid; border-bottom-color: #00509F; border-bottom-width: thin;"
            ...
            <th colspan="6" align="left" style="font-family:Century Gothic ; font-size: 16PX; font-weight: bold;
                color:Blue ">
             <marquee > Completed And InProcess Status</marquee>
            </th>
        </tr>
            ...
            <tr>
            <td>
            <asp:RadioButtonList id="RadioButtonList" runat="server" AutoPostBack ="true"  RepeatDirection="Horizontal" >
         ...
         <asp:ListItem Selected="True">In Process</asp:ListItem>
            ...
            <tr>
                <td align="right">
                    <telerik:RadButton ID="btnAddSampling"  Visible ="false" runat="server" Text="Add Task" Skin="WebBlue">
                    </telerik:RadButton>
                </td>
            </tr>
            ...
            <tr>
                <td>
                <div style="width :920PX; overflow :scroll ; height :700px;" >
                    <telerik:RadGrid ID="dgRND" runat="server" CellSpacing="0"  AutoGenerateColumns="False"
                        ...
                        ShowGroupPanel="True" PageSize="10000" OnSortCommand="dgRND_SortCommand"    OnPageIndexChanged="dgRND_PageIndexChanged"
                        ...
                        <MasterTableView AutoGenerateColumns="false" AllowFilteringByColumn="True" ShowFooter="True"
                            ...
                            <ExpandCollapseColumn Visible="True" FilterControlAltText="Filter ExpandColumn column">
                             ...
                             <Columns>
                                <telerik:GridBoundColumn HeaderText="PATTERNDEPARTMENTTASKLISTMstid" DataField="PATTERNDEPARTMENTTASKLISTMstid" Display="false">
...
<telerik:GridBoundColumn HeaderText="Task No" DataField="TaskNo" AllowFiltering="false" ItemStyle-Font-Bold="true"  ItemStyle-Font-Names ="Calibri" ItemStyle-Font-Size ="Medium" ItemStyle-ForeColor="Blue"
                                ...
                                <telerik:GridBoundColumn HeaderText="Priority" DataField="Priority" AllowFiltering="false"
                                ...
                                <telerik:GridBoundColumn HeaderText="Type" DataField="Typee" AllowFiltering="false"
                                    FilterControlWidth="50px" ItemStyle-Font-Bold="true"  ItemStyle-Font-Names ="Calibri" ItemStyle-Font-Size ="Medium" ItemStyle-ForeColor="Blue"
                                    AutoPostBackOnFilter="false" CurrentFilterFunction="StartsWith"
                                    FilterDelay="3000" ShowFilterIcon="false">
                                    <ItemStyle HorizontalAlign="Center" />
                                ...
                                <telerik:GridBoundColumn HeaderText="Date Time Stamp" DataField="DateTimeStampp" AllowFiltering="false" Display ="false" 
                                    FilterControlWidth="70px" ItemStyle-Font-Bold="true"  ItemStyle-Font-Names ="Calibri" ItemStyle-Font-Size ="Medium" ItemStyle-ForeColor="Blue"
                                      AutoPostBackOnFilter="false" CurrentFilterFunction="StartsWith"
                                    FilterDelay="3000" ShowFilterIcon="false">
                                    <ItemStyle HorizontalAlign="Center" />
                                  ...
                                  <telerik:GridBoundColumn HeaderText="Finish Time Stamp" DataField="FinishTimeStamp" AllowFiltering="false" Display ="true" 
                                    FilterControlWidth="70px" ItemStyle-Font-Bold="true"  ItemStyle-Font-Names ="Calibri" ItemStyle-Font-Size ="Medium" ItemStyle-ForeColor="Blue"
                                      AutoPostBackOnFilter="false" CurrentFilterFunction="StartsWith"
                                    FilterDelay="3000" ShowFilterIcon="false">
                                    <ItemStyle HorizontalAlign="Center" />
                                 ...
                                 <telerik:GridBoundColumn HeaderText="Status" DataField="Status" Display="false">
                                  ...
                                  <telerik:GridBoundColumn HeaderText="Con Status" DataField="ConStatus" UniqueName="ConStatus" ItemStyle-Font-Bold="true"
                                    ItemStyle-Font-Size="Large" ItemStyle-Font-Names ="Calibri" ItemStyle-ForeColor="Red" Display="true" AllowFiltering="false">
                                    <ItemStyle HorizontalAlign="Center" />
                                    <HeaderStyle Width="2%" HorizontalAlign="Left" />
                                </telerik:GridBoundColumn>
                                  <telerik:GridTemplateColumn HeaderText="GGT Status" UniqueName="Statuss" AllowFiltering="false"
                                        Display="true">
                                        <ItemTemplate>
                                           <asp:ImageButton id="lnkAccessoriese" tooltip="Click here to Accessoriese"  ImageUrl="~/Images/mail1.jpg" CommandName="Accessoriese" runat="server"></asp:ImageButton>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                      ...
                                      <telerik:GridBoundColumn HeaderText="Bit" DataField="Bit" Display="false">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <HeaderStyle Width="2%" HorizontalAlign="Left" />
                                </telerik:GridBoundColumn>
                                   ...
                                   <telerik:GridTemplateColumn HeaderText="View" UniqueName="View" AllowFiltering="false"
                                        Display="true">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="lnkEdit" Font-Underline="false" Text="Update" Enabled="true" NavigateUrl='<%# "PatternDepartmentTaskListEntry.aspx?lPATTERNDEPARTMENTTASKLISTMstid=" &amp; DataBinder.Eval(Container.DataItem,"PATTERNDEPARTMENTTASKLISTMstid")&"&Status=G"%>'
                        ...
                        <PagerStyle PageSizeControlType="RadComboBox" Position ="TopAndBottom" visible="false"  ></PagerStyle>
