<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="BuyerCommentView.aspx.vb" Inherits="Integra.BuyerCommentView" %>
...
<telerik:RadWindowManager ID="RadWindowManager1" runat="server">
 ...
 <table width ="100%">
            <tr>
                <td align="right">
                    <telerik:RadButton ID="btnAdd" runat="server" Text="Add Comment" Skin="WebBlue">
                    </telerik:RadButton>
                </td>
            </tr>
            <tr>
                <td>
                    <telerik:RadGrid ID="dgCourier" runat="server" CellSpacing="0" AutoGenerateColumns="False"
                        ...
                        <MasterTableView AutoGenerateColumns="false" AllowFilteringByColumn="True" ShowFooter="True"
                            ...
                            <Columns>
                                <telerik:GridBoundColumn HeaderText="BuyerCommentID" DataField="BuyerCommentID" Display="false">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <HeaderStyle Width="2%" HorizontalAlign="Left" />
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn HeaderText="Date" AllowFiltering="false" DataField="CommentDatee">
                                    <HeaderStyle Width="9%" HorizontalAlign="center" />
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn HeaderText="DCD No." DataField="DCDNo" AllowFiltering="true"
                                ...
                                <telerik:GridBoundColumn HeaderText="Buyer Comment" DataField="BuyerComment" AllowFiltering="true"
                                    FilterControlWidth="50px" AutoPostBackOnFilter="false" CurrentFilterFunction="StartsWith"
                                    FilterDelay="3000" ShowFilterIcon="false">
                                    <ItemStyle HorizontalAlign="Left" />
                            ...
                            <ItemTemplate>
                                <asp:ImageButton ID="lnkPDF" ToolTip="Click here to download PDF" ImageUrl="~/Images/pdfIcon.png"
                                    CommandName="PDF" runat="server" Visible ="false" ></asp:ImageButton>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
