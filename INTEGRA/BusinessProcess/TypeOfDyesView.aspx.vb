...
Public Class TypeOfDyesView
    ...
    Function LoadData() As ICollection
        ...
        objDataTable = objTypeOfDyes.GetAllh()
    ...
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
        Response.Redirect("TypeOfDyesEntry.aspx")
    End Sub
    Protected Sub dgPurchaseOrder_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles dgPurchaseOrder.ItemCommand
        Select Case e.CommandName
            Case Is = "Remove"
                Dim TypeOfDyesID As Long = dgPurchaseOrder.Items(e.Item.ItemIndex).Cells(0).Text
                objTypeOfDyes.deletepodtl(TypeOfDyesID)
                objDataView = LoadData()
                Session("objDataView") = objDataView
                BindGrid()
