<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="OfferDevSampleRecvFromSupplier.aspx.vb" Inherits="Integra.OfferDevSampleRecvFromSupplier" %>
    ...
    <table width="100%">
        <tr style="border-bottom-style: solid; border-bottom-color: #00509F; border-bottom-width: thin;"
            ...
            <th colspan="6" align="left" style="font-family: Arial; font-size: 16PX; font-weight: bold;
                color: #808080;">
                Offer/Development Sample Received From Supplier
            </th>
        </tr>
    </table>
    <table width="100%">
                                    ...
                                    <asp:TemplateColumn HeaderText="Sample Type">
                                        ...
                                        <ItemTemplate>
                                            <asp:DropDownList ID="cmbSampleType" CssClass="dd" Width="100" runat="server">
                                                <asp:ListItem>Offer Sample</asp:ListItem>
                                                <asp:ListItem>Development Sample</asp:ListItem>
                                                <asp:ListItem>Counter Sample</asp:ListItem>
