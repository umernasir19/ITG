...
Partial Public Class DPStyleDatabaseView
    ...
    '''<summary>
    '''btnStyleDatabase control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents btnStyleDatabase As Global.Telerik.Web.UI.RadButton

    '''<summary>
    '''dgStyleDatabase control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents dgStyleDatabase As Global.Telerik.Web.UI.RadGrid
End Class
