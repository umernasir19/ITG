<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="BuyCoverAdd.aspx.vb" Inherits="Integra.BuyCoverAdd" %>
...
<table width="100%">
 ...
 <tr>
          ...
          Buyer
               ...
               <td style="width: 110px;">
            <asp:TextBox ID="txtBuyer" runat="server" CssClass="forcapital" ReadOnly ="false" AutoPostBack="false" Width="150px" style=" margin-left: -148px;margin-top: 2px;"></asp:TextBox>
            </td>
          </tr>
            <tr>
            <td style="width: 110px;">
               ...
               <td style="width: 110px;">
            <asp:TextBox ID="txtAdress" runat="server" CssClass="forcapital" ReadOnly ="false"  TextMode ="MultiLine"    AutoPostBack="false" Width="150px" style=" margin-left: -148px;margin-top: 2px;"></asp:TextBox>
            </td>
          </tr>
             ...
             <tr>
                            <td colspan ="2" >
                                <telerik:RadGrid ID="dgDetail" runat="server" CellSpacing="0" AutoGenerateColumns="false"
                                    ...
                                    <MasterTableView>
                                        <Columns>
                                            <telerik:GridBoundColumn HeaderText="BuyerCoverDtlId" DataField="BuyerCoverDtlId" Display="false">
