<%@ Page Language="vb"  MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeBehind="CuttingAprovalSheet.aspx.vb" Inherits="Integra.CuttingAprovalSheet" %>
...
<div>
    <table width="100%">
        ...
        <asp:UpdatePanel ID="UpdatePanel3" UpdateMode="Conditional" runat="server">
               <ContentTemplate>
            <telerik:RadGrid ID="dgCuttingAprovalSheet" runat="server" CellSpacing="0" 
                AutoGenerateColumns="False"  Skin="WebBlue" AllowFilteringByColumn ="True" 
                AllowPaging="True" GridLines="None" 
                ShowGroupPanel="false" PageSize="50" OnSortCommand="dgCuttingAprovalSheet_SortCommand"
                 OnPageIndexChanged="dgCuttingAprovalSheet_PageIndexChanged"
             ShowStatusBar="True" 
...
<ExpandCollapseColumn Visible="True" FilterControlAltText="Filter ExpandColumn column"></ExpandCollapseColumn>
           ...
           <ItemStyle HorizontalAlign="Left" />
            ...
            <HeaderStyle Width="7%" HorizontalAlign="Left" Font-Size="Smaller"/>
               ...
               <telerik:GridBoundColumn HeaderText="Style No" DataField="StyleNo" AllowFiltering ="false" FilterControlWidth="65px" AutoPostBackOnFilter="false" CurrentFilterFunction="StartsWith"
                    FilterDelay="4000" ShowFilterIcon="false">
            <ItemStyle HorizontalAlign="Left" />
            <HeaderStyle Width="7%" HorizontalAlign="Left" Font-Size="Smaller"/>
            </telerik:GridBoundColumn>  
            ...
            <telerik:GridTemplateColumn  HeaderText="Action"  AllowFiltering ="false">
              <itemstyle horizontalalign="Center" />
               <HeaderStyle Width="5%" HorizontalAlign="Center" Font-Size="Smaller"/>
				<ITEMTEMPLATE>
   <asp:LinkButton ID="lnkApprove"  runat ="server" CommandName ="Approved" HeaderText ="View" Text="Approve" ></asp:LinkButton>
        </ITEMTEMPLATE>
   <headerstyle width="5%" />
