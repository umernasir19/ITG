<%@ Page Language="vb" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeBehind="MasterOrderForSupplyChain.aspx.vb" Inherits="Integra.MasterOrderForSupplyChain" %>
                ...
                <td align="right">
                    ...
                    <telerik:RadComboBox ID="cmbAction" runat="server" AutoPostBack="True" Skin="WebBlue">
                        <Items>
                            ...
                            <telerik:RadComboBoxItem Value="1" Text="Create Final Status" />
                            <telerik:RadComboBoxItem Value="2" Text="View Purchase Order" />
                            <telerik:RadComboBoxItem Value="3" Text="Download Original PO" />
                            <telerik:RadComboBoxItem Value="4" Text="View Milestone" />
                             <telerik:RadComboBoxItem Value="5" Text="View Production Status" />
                        </Items>
                    </telerik:RadComboBox>
                        </ContentTemplate>
                   </asp:UpdatePanel>
            ...
            <tr>
                <td colspan="6">
                    <telerik:RadGrid ID="dgMasterOrderForSupplyChain" runat="server" CellSpacing="0"
                        ...
                        GridLines="None" ShowGroupPanel="True" PageSize="15" OnSortCommand="dgMasterOrderForSupplyChain_SortCommand" OnPageIndexChanged="dgMasterOrderForSupplyChain_PageIndexChanged" ShowStatusBar="True" StatusBarSettings-ReadyText="Loading"
                        ...
                        <MasterTableView AutoGenerateColumns="false" AllowFilteringByColumn="True" ShowFooter="True"
                           ...
                           <%--     <telerik:GridBoundColumn HeaderText="Shipped Qty" DataField="ShippedQty" UniqueName="ShippedQty"
                                    GroupByExpression="ShippedQty ShippedQty Group By ShippedQty" AllowFiltering="false">
                                    <HeaderStyle Width="7%" HorizontalAlign="Left" Font-Size="Smaller" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </telerik:GridBoundColumn>--%>
