<%@ Page Language="vb" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeBehind="PurchaseOrderAdd.aspx.vb" Inherits="Integra.PurchaseOrderAdd" %>
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td class="TopHeaderTable3" style="width: 166px; height: 30px;">
                    <asp:TextBox ID="txtPONO" runat="server" CssClass="textbox" Width="190">
                    </asp:TextBox>
                </td>
                <td style="width: 128px; height: 30px;">
                    <asp:Label ID="Label1" runat="server" Text="Inq. Date"></asp:Label>
                </td>
                <td class="TopHeaderTable3" style="width: 166px; height: 30px;">
                ...
                <td class="TopHeaderTable3" style="width: 166px; height: 30px;">
                    <asp:DropDownList ID="cmbStage" Width="110" runat="server">
