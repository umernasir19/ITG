<%@ Page Title="Godown Transfer" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="GodownTransferViewForProcess.aspx.vb" Inherits="Integra.GodownTransferViewForProcess" %>
        ...
        <tr>
            ...
            <td style="width: 20%">
                ...
                <cc1:AutoCompleteExtender runat="server" ID="autoComplete1" TargetControlID="txtShowMe"
                    ...
                    CompletionInterval="10" EnableCaching="true" CompletionSetCount="12" ContextKey="GodownViewSearchForProcess" />
            </td>
            <td style="width: 10%">
                <asp:UpdatePanel ID="btnSearchUPdate" UpdateMode="Conditional" runat="server">
                    <ContentTemplate>
                        <asp:Button ID="btnSearch" runat="server" CssClass="button" Visible ="false" Text="Search" Width="80"
                           ></asp:Button>
                    </ContentTemplate>
                    <Triggers>
