...
Public Class VAFPanel
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        VAFID = objVender.DecryptString(Request.QueryString("VAFID"))
        SupplierID = objVender.DecryptString(Request.QueryString("SupplierID"))
    ...
    Protected Sub btnDetail_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnDetail.Click
        Try
            If txtName.Text = "" Then
                DirectCast(Me.Page.Master, MasterPage).ShowMessgae("Name Empty")
            ElseIf txtPhone.Text = "" Then
                DirectCast(Me.Page.Master, MasterPage).ShowMessgae("Phone No. Empty")
            ElseIf txtCell.Text = "" Then
                DirectCast(Me.Page.Master, MasterPage).ShowMessgae("Cell No. Empty")
            ElseIf txtEmail.Text = "" Then
                DirectCast(Me.Page.Master, MasterPage).ShowMessgae("Email Empty")
            Else
