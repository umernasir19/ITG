...
Public Class DPCourierView
    ...
    Sub GetRights()
        ...
        If dt.Rows.Count > 0 Then
            ...
            End If
            If View = 1 Then
                dgCourier.MasterTableView.GetColumn("View").Display = True
            Else
                dgCourier.MasterTableView.GetColumn("View").Display = False
            End If
        End If
    End Sub
    ...
    Function LoadData() As ICollection
        ...
        objDataTable = ObjDPCourierMst.GetView()
    ...
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
        Try
            Response.Redirect("CourierDetail.aspx")
        Catch ex As Exception
        ...
        Try
            Select Case e.CommandName
                Case Is = "PDF"
                    ...
                    di.Create()
                    Dim FileName As String = "CourierDetail"
