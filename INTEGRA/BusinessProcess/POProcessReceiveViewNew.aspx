<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="POProcessReceiveViewNew.aspx.vb" Inherits="Integra.POProcessReceiveViewNew" %>
        ...
        <tr>
            ...
            <td style="width: 20%">
                <asp:TextBox ID="txtShowMe" runat="server" AutoPostBack="true" autocomplete="off"
                    Width="196px" ToolTip="Item Name" Visible="true"> </asp:TextBox>
                <cc1:AutoCompleteExtender runat="server" ID="autoComplete1" TargetControlID="txtShowMe"
                    ServicePath="../AutoComplete.asmx" ServiceMethod="GetCompletionList" MinimumPrefixLength="1"
                    CompletionInterval="10" EnableCaching="true" CompletionSetCount="12" ContextKey="GetProcessReceivingSearching" />
            </td>
            <td style="width: 10%">
                ...
                <Smart:SmartDataGrid ID="dgView" runat="server" Width="100%" OnSortCommand="SortByColumn"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn ItemStyle-HorizontalAlign="center" HeaderStyle-Width="2%" HeaderText="PORecvMasterID"
                            DataField="POProcessRecvMasterID" Visible="false" />
                        ...
                        <asp:BoundColumn ItemStyle-HorizontalAlign="center" HeaderText="Fabric Code" DataField="ItemCodee">
                            <HeaderStyle HorizontalAlign="center" Width="8%" />
                        </asp:BoundColumn>
