...
Public Class GodownTarnsfer
    ...
    Protected Sub txtITEMCODE_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtITEMCODE.TextChanged
        Try
            ...
            If cmbLocationFrom.SelectedValue = 10 Then
                Dim dtIssue As DataTable = ObjIssue.GetInhandQtyFORiSSUECodeAndLocationViseRecvForUpdate(lblItemId.Text, cmbLocationFrom.SelectedValue)
                Dim dtIssueSubtarct As DataTable = ObjIssue.GetInhandQtyFORiSSUECodeAndLocationViseRecvForUpdateForSubtract(lblItemId.Text, cmbLocationFrom.SelectedValue)
                txtQtyInHand.Text = dtIssue.Rows(0)("RecvQty") - dtIssueSubtarct.Rows(0)("RecvQty")
            Else
                Dim dtIssue As DataTable = ObjIssue.GetInhandQtyFORiSSUECodeAndLocationVise(lblItemId.Text, cmbLocationFrom.SelectedValue)
                Dim dtRecv As DataTable = ObjIssue.GetInhandQtyFORiSSUECodeAndLocationViseRecv(lblItemId.Text, cmbLocationFrom.SelectedValue)
                Dim dtRecvSubtract As DataTable = ObjIssue.GetInhandQtyFORiSSUECodeAndLocationViseRecvNewww(lblItemId.Text, cmbLocationFrom.SelectedValue)
        ...
        Try
            ...
            If cmbSeason.SelectedItem.Text = "Select" And cmbSrNo.SelectedItem.Text = "Select" Then
                ...
                Else
                    Dim dtIssue As DataTable = ObjIssue.GetInhandQtyFORiSSUECodeAndLocationVise(lblItemId.Text, cmbLocationFrom.SelectedValue)
                    Dim dtRecv As DataTable = ObjIssue.GetInhandQtyFORiSSUECodeAndLocationViseRecv(lblItemId.Text, cmbLocationFrom.SelectedValue)
                    Dim dtRecvSubtract As DataTable = ObjIssue.GetInhandQtyFORiSSUECodeAndLocationViseRecvForSubtract(lblItemId.Text, cmbLocationFrom.SelectedValue)
                    txtQtyInHand.Text = (dtIssue.Rows(0)("IssueQty") + dtRecv.Rows(0)("RecvQty")) - dtRecvSubtract.Rows(0)("RecvQty")
                End If
            ElseIf cmbSeason.SelectedItem.Text = "Select" And cmbSrNo.SelectedItem.Text <> "Select" Then
                If cmbLocationFrom.SelectedValue = 10 Then
                    Dim dtIssue As DataTable = ObjIssue.GetInhandQtyFORiSSUECodeAndLocationViseRecvForUpdateForNew(lblItemId.Text, cmbLocationFrom.SelectedValue, cmbSrNo.SelectedValue)
                    Dim dtIssueSubtract As DataTable = ObjIssue.GetInhandQtyFORiSSUECodeAndLocationViseRecvForUpdateForNewForSubtract(lblItemId.Text, cmbLocationFrom.SelectedValue, cmbSrNo.SelectedValue)
                    txtQtyInHand.Text = dtIssue.Rows(0)("RecvQty") - dtIssueSubtract.Rows(0)("RecvQty")
                Else
                    Dim dtIssue As DataTable = ObjIssue.GetInhandQtyFORiSSUECodeAndLocationViseOnlySRNO(lblItemId.Text, cmbLocationFrom.SelectedValue, cmbSrNo.SelectedValue)
                    Dim dtRecv As DataTable = ObjIssue.GetInhandQtyFORiSSUECodeAndLocationViseRecvonlySRNO(lblItemId.Text, cmbLocationFrom.SelectedValue, cmbSrNo.SelectedValue)
                    Dim dtRecvSubtract As DataTable = ObjIssue.GetInhandQtyFORiSSUECodeAndLocationViseRecvonlySRNOForSubtract(lblItemId.Text, cmbLocationFrom.SelectedValue, cmbSrNo.SelectedValue)
                    txtQtyInHand.Text = (dtIssue.Rows(0)("IssueQty") + dtRecv.Rows(0)("RecvQty")) - dtRecvSubtract.Rows(0)("RecvQty")
                End If
            ElseIf cmbSeason.SelectedItem.Text <> "Select" And cmbSrNo.SelectedItem.Text = "Select" Then
                If cmbLocationFrom.SelectedValue = 10 Then
                    Dim dtIssue As DataTable = ObjIssue.GetInhandQtyFORiSSUECodeAndLocationViseRecvForUpdateForNewFOrUpdate(lblItemId.Text, cmbLocationFrom.SelectedValue, cmbSeason.SelectedValue)
                    Dim dtIssueSubtract As DataTable = ObjIssue.GetInhandQtyFORiSSUECodeAndLocationViseRecvForUpdateForNewFOrUpdateForSubtract(lblItemId.Text, cmbLocationFrom.SelectedValue, cmbSeason.SelectedValue)
                    txtQtyInHand.Text = dtIssue.Rows(0)("RecvQty") - dtIssueSubtract.Rows(0)("RecvQty")
                Else
                    Dim dtIssue As DataTable = ObjIssue.GetInhandQtyFORiSSUECodeAndLocationViseSeason(lblItemId.Text, cmbLocationFrom.SelectedValue, cmbSeason.SelectedValue)
                    Dim dtRecv As DataTable = ObjIssue.GetInhandQtyFORiSSUECodeAndLocationViseRecvSeason(lblItemId.Text, cmbLocationFrom.SelectedValue, cmbSeason.SelectedValue)
                    Dim dtRecvSubtract As DataTable = ObjIssue.GetInhandQtyFORiSSUECodeAndLocationViseRecvSeasonForSubtract(lblItemId.Text, cmbLocationFrom.SelectedValue, cmbSeason.SelectedValue)
                    txtQtyInHand.Text = (dtIssue.Rows(0)("IssueQty") + dtRecv.Rows(0)("RecvQty")) - dtRecvSubtract.Rows(0)("RecvQty")
                End If
            ElseIf cmbSeason.SelectedItem.Text <> "Select" And cmbSrNo.SelectedItem.Text <> "Select" Then
                If cmbLocationFrom.SelectedValue = 10 Then
                    Dim dtIssue As DataTable = ObjIssue.GetInhandQtyFORiSSUECodeAndLocationViseRecvForUpdateForNewFOrUpdateForNeww(lblItemId.Text, cmbLocationFrom.SelectedValue, cmbSeason.SelectedValue, cmbSrNo.SelectedValue)
                    Dim dtIssueForSubtract As DataTable = ObjIssue.GetInhandQtyFORiSSUECodeAndLocationViseRecvForUpdateForNewFOrUpdateForNewwForSubtract(lblItemId.Text, cmbLocationFrom.SelectedValue, cmbSeason.SelectedValue, cmbSrNo.SelectedValue)
                    txtQtyInHand.Text = dtIssue.Rows(0)("RecvQty") - dtIssueForSubtract.Rows(0)("RecvQty")
                Else
                    Dim dtIssue As DataTable = ObjIssue.GetInhandQtyFORiSSUECodeAndLocationViseSeasonaNDSRNO(lblItemId.Text, cmbLocationFrom.SelectedValue, cmbSeason.SelectedValue, cmbSrNo.SelectedValue)
                    Dim dtRecv As DataTable = ObjIssue.GetInhandQtyFORiSSUECodeAndLocationViseRecvSeasonAndSrNo(lblItemId.Text, cmbLocationTo.SelectedValue, cmbSeason.SelectedValue, cmbSrNo.SelectedValue)
                    Dim dtRecvSubtract As DataTable = ObjIssue.GetInhandQtyFORiSSUECodeAndLocationViseRecvSeasonAndSrNoForSubtract(lblItemId.Text, cmbLocationTo.SelectedValue, cmbSeason.SelectedValue, cmbSrNo.SelectedValue)
                    txtQtyInHand.Text = (dtIssue.Rows(0)("IssueQty") + dtRecv.Rows(0)("RecvQty")) - dtRecvSubtract.Rows(0)("RecvQty")
                End If
                End If
        Catch ex As Exception
    ...
    End Sub
    Sub GetInhandQty()
        Dim dt As DataTable = ObjIssue.GetInhandQtyForGodownTransfer(lblItemId.Text, cmbSrNo.SelectedValue, cmbSeason.SelectedValue, cmbLocationFrom.SelectedValue)
    ...
    Sub VoucherNoGenerateOnLoad()
        Try
            ...
            Dim LastVoucherNo As String = objGodownIssueMst.GetIssueCode(year)
            ...
            Else
                ...
                ElseIf DtCheck.Rows(0)("Department") = "General Store." Then
                    VoucherNo = "DAL" & "-" & "GG" & "-" & LastCode & "-" & yearv
                    txtStoreIssueVoucherNo.Text = VoucherNo
                End If
            End If
        Catch ex As Exception
        ...
        Try
            ...
            Else
                ...
                For x = 0 To dgItemView.Items.Count - 1
                    ...
                    With objGodownIssueDetail
                        .GodownIssueDetailID = dgItemView.Items(x).Cells(0).Text
                        If lGodownIssueID > 0 Then
                            .GodownIssueID = lGodownIssueID
                        Else
                            .GodownIssueID = objGodownIssueMst.GetID()
                        End If
                ...
                Session("dtSelection") = Nothing
                Session("dtItemIssue") = Nothing
                Response.Redirect("GodownTransferView.aspx")
            End If
        Catch ex As Exception
        End Try
    End Sub
    Sub EditMode()
        Try
            Dim dt As DataTable = ObjIMSStoreIssue.GetEditDataForGodownIssueNew(lGodownIssueID)
