<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="SeasonView.aspx.vb" Inherits="Integra.SeasonView" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="100%">
        <tr>
            <td align="right">
                <asp:Button ID="btnAdd" runat="server" CssClass="button" Text="Add Season" Width="180">
                </asp:Button>
            </td>
        </tr>
        <tr>
...
<ASP:TEMPLATECOLUMN HeaderText="Edit" Visible ="true" >
									...
									<ITEMTEMPLATE>
<asp:HyperLink id="lnkEdit" Runat="server" NavigateUrl='<%# "SeasonEntry.aspx?SeasonDatabaseID=" &amp; DataBinder.Eval(Container.DataItem,"SeasonDatabaseID")%>' Enabled="true">
											Edit
										</asp:HyperLink> 
</ITEMTEMPLATE>
