<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master"
    CodeBehind="ProcessOrderEntry.aspx.vb" Inherits="Integra.ProcessOrderEntry" %>
        ...
        <div class="header_columns">
            ...
            <table>
                ...
                <tr style="height: 30px;">
                    ...
                    <asp:Panel ID="PnlIssueTypeCmb" runat="server" Visible="true">
                        <td style="height: 35px">
                            <%--  <div class="txt" style="width: 100px; margin-left: -45px;">--%>
                            Process Type :
                            <%-- </div>--%>
                        </td>
                        <td style="height: 35px">
                            <div class="text_box" style="margin-left: 10px;">
                                <asp:DropDownList ID="cmbIssueType" runat="server" AutoPostBack="false" CssClass="combo"
                                    Width="140px" Style="margin-left: -12px; height: 26px;">
                                </asp:DropDownList>
                            </div>
                        </td>
                        <td>
                            <asp:ImageButton ID="BtnAddIssueType" runat="server" ImageUrl="~/Images/AddButton.jpg"
                                Style="margin-left: -28px; width: 17px; margin-top: 0px; height: 17px;" />
                        </td>
                    </asp:Panel>
                    <asp:Panel ID="PnlIssueTypetxt" runat="server" Visible="false">
                        <td style="height: 35px">
                            <%-- <div class="txt" style="width: 95px; margin-left: -50px;">--%>
                            Process Type :
                            <%-- </div>--%>
                        </td>
                        <td style="height: 35px">
                            <div class="text_box" style="width: 130px; margin-left: 10px;">
                                <asp:TextBox ID="txtIssueType" CssClass="textbox" Width="145" runat="server" Style="margin-left: -12px;
                                    height: 22px;">
                                </asp:TextBox>
                            </div>
                            <asp:ImageButton ID="BtnSaveIssueType" runat="server" ImageUrl="~/Images/SaveButton.jpg"
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtIssueCode" AutoPostBack="true" CssClass="textbox" runat="server"
                            Style="margin-left: 0px;"></asp:TextBox>
                        <cc1:AutoCompleteExtender runat="server" ID="AutoCompleteExtender3" TargetControlID="txtIssueCode"
                            ServicePath="../AutoComplete.asmx" ServiceMethod="GetCompletionList" MinimumPrefixLength="1"
                            CompletionInterval="10" EnableCaching="true" CompletionSetCount="12" ContextKey="IssueCode" />
                    </td>
                    <asp:Label ID="lblIssueCode" runat="server"></asp:Label>
                </tr>
                <tr style="height: 30px;">
                    <td>
                        Item Type:
                    ...
                    <td>
                        <asp:DropDownList ID="cmbProcessType" Width="133px" CssClass="combo" AutoPostBack="true"
                ...
                <tr style="height: 30px;">
                    ...
                    <td colspan="2">
                        <asp:UpdatePanel ID="udpcmbProduct" runat="server" ChildrenAsTriggers="true">
                            <ContentTemplate>
                                ...
                                <asp:DropDownList ID="cmbproduct" Width="270px" CssClass="combo" AutoPostBack="true"
                    ...
                    <td colspan="2">
                        <asp:DropDownList ID="cmbProcessItemName" Width="133px" CssClass="combo" AutoPostBack="true"
                            runat="server" Style="margin-left: 0px;">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr style="height: 30px;">
                    ...
                    <td>
                        <asp:Label ID="lblQuality" runat="server" Text="Process Quality:"></asp:Label>
                    </td>
                    <td colspan="2">
                        <asp:UpdatePanel ID="udpProcessQuality" runat="server" ChildrenAsTriggers="true">
                            <ContentTemplate>
                                <asp:TextBox ID="txtProcessQuality" CssClass="textbox" Width="340px" runat="server"></asp:TextBox>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="1">
                        <asp:UpdatePanel ID="uptxtItemShade" runat="server" ChildrenAsTriggers="true">
                            <ContentTemplate>
                                <asp:TextBox ID="txtItemShade" CssClass="textbox" runat="server"></asp:TextBox>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtRemarksDetail" CssClass="textbox" Width="216px" runat="server"
                ...
                <tr style="height: 30px;">
                    ...
                    <td colspan="2">
                        <asp:UpdatePanel ID="UptxtPORate" runat="server" ChildrenAsTriggers="true">
                            <ContentTemplate>
                                <asp:TextBox ID="txtPORate" CssClass="textbox" runat="server"></asp:TextBox>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        <asp:UpdatePanel ID="udplblInvoiceQTY" runat="server" ChildrenAsTriggers="true">
                            <ContentTemplate>
                                <asp:Label ID="lblInvoiceQTY" Visible="false" runat="server"></asp:Label>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </td>
                    <td>
                            ...
                            <Smart:SmartDataGrid ID="dgProductdetail" runat="server" Width="100%" AllowPaging="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundColumn ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="10%" HeaderText="From"
                                        DataField="DeptDatabaseName" Visible="False">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <HeaderStyle Width="15%" HorizontalAlign="Center" />
                                    </asp:BoundColumn>
                                    ...
                                    <asp:BoundColumn ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="1%" HeaderText="IssueTypeID"
                                        DataField="IssueTypeID" Visible="FALSE">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <HeaderStyle Width="1%" HorizontalAlign="Center" />
                                    </asp:BoundColumn>
                                    <asp:BoundColumn ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="25%" HeaderText="Issue Type"
                                        DataField="IssueType">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <HeaderStyle Width="15%" HorizontalAlign="Center" />
                                    </asp:BoundColumn>
                                    <asp:BoundColumn ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="25%" HeaderText="ProcessItemCodeID"
                                        DataField="ProcessItemCodeID" Visible="False">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <HeaderStyle Width="15%" HorizontalAlign="Center" />
                                    </asp:BoundColumn>
                                    <asp:BoundColumn ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="25%" HeaderText="Process Item Code"
                                        DataField="ProcessItemCode">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <HeaderStyle Width="15%" HorizontalAlign="Center" />
                                    </asp:BoundColumn>
                                    <asp:BoundColumn ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="25%" HeaderText="ProcessItemTypeID"
                                        DataField="ProcessItemTypeID" Visible="False">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <HeaderStyle Width="15%" HorizontalAlign="Center" />
                                    </asp:BoundColumn>
                                    <asp:BoundColumn ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="25%" HeaderText="Process Item Type"
                                        DataField="ProcessItemType">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <HeaderStyle Width="15%" HorizontalAlign="Center" />
                                    </asp:BoundColumn>
                                    <asp:BoundColumn ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="25%" HeaderText="Process ItemName ID"
                                        DataField="ProcessItemNameID" Visible="False">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <HeaderStyle Width="15%" HorizontalAlign="Center" />
                                    </asp:BoundColumn>
                                    <asp:BoundColumn ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="25%" HeaderText="Process Item Name"
                                        DataField="ProcessItemName">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <HeaderStyle Width="15%" HorizontalAlign="Center" />
                                    </asp:BoundColumn>
                                    <asp:BoundColumn ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="25%" HeaderText="Process Quality"
                                        DataField="ProcessQuality">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <HeaderStyle Width="15%" HorizontalAlign="Center" />
                                    </asp:BoundColumn>
                                    <asp:BoundColumn ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="25%" HeaderText="Process Shade"
                                        DataField="ProcessShade">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <HeaderStyle Width="15%" HorizontalAlign="Center" />
                                    </asp:BoundColumn>
                                    <asp:BoundColumn ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="25%" HeaderText="Process Quantity"
                                        DataField="ProcessQuantity">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <HeaderStyle Width="15%" HorizontalAlign="Center" />
                                    </asp:BoundColumn>
                                    <asp:BoundColumn ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="25%" HeaderText="Process SalesTax%"
                                        DataField="ProcessSalesTax">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <HeaderStyle Width="15%" HorizontalAlign="Center" />
                                    </asp:BoundColumn>
                                    <asp:BoundColumn ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="25%" HeaderText="SR No"
                                        DataField="SRNo">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <HeaderStyle Width="15%" HorizontalAlign="Center" />
                                    </asp:BoundColumn>
                                    <asp:BoundColumn ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="5%" HeaderText="SRNoID"
                                        DataField="SRNoID" Visible="False" />
                                    ...
                                    <asp:BoundColumn ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="1%" HeaderText="PO Rate"
                                        DataField="PORate" Visible="true">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <HeaderStyle Width="1%" HorizontalAlign="Center" />
                                    </asp:BoundColumn>
