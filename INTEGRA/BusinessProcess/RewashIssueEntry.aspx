<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="RewashIssueEntry.aspx.vb" Inherits="Integra.RewashIssueEntry" %>
 ...
 <script type="text/javascript">
    ...
    <table>
        ...
        <tr>
            ...
            <td  style="padding:5px;">
                <asp:TextBox ID="txtRewashIssueQty" runat="server" Width="150px" CssClass="textbox" Style=" height: 16px;"  onkeypress="return isNumericKeyy(event);"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>
