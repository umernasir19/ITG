...
Partial Public Class MasterOrderForDataFeederNeww
    ...
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents btnAddOrder As Global.Telerik.Web.UI.RadButton

    '''<summary>
    '''dgMasterOrderForDataFeeder control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents dgMasterOrderForDataFeeder As Global.Telerik.Web.UI.RadGrid
End Class
