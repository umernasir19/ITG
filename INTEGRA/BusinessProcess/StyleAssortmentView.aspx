<%@ Page Title="Style Assortment View" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master"
    CodeBehind="StyleAssortmentView.aspx.vb" Inherits="Integra.StyleAssortmentView" %>
        ...
        <td align="right" >
          <asp:TextBox CssClass="textbox" ID="txtSearch" AutopostBack="true"  style="height :20px; margin-left: 10px;" runat="server" ReadOnly="false" ></asp:TextBox>
           <cc1:AutoCompleteExtender ID="AutoCompleteExtender2" runat="server" CompletionInterval="10"
                                        CompletionSetCount="12" ContextKey="SearchingFromStyleAssorment" EnableCaching="true" MinimumPrefixLength="1"
            ...
            <td>
                <Smart:SmartDataGrid ID="dgView" runat="server" Width="100%" OnSortCommand="SortByColumn"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="05%" HeaderText="ASSORT.">
                            <ItemTemplate>
