...
Partial Public Class DPFabricDBView
    ...
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents btnAddSampling As Global.Telerik.Web.UI.RadButton
    ...
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents dgFabricDB As Global.Telerik.Web.UI.RadGrid
End Class
