<%@ Page Language="vb" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeBehind="MasterOrderForMerchandisers.aspx.vb" Inherits="Integra.MasterOrderForMerchandisers" %>
                ...
                <td align="right">
                    ...
                    <telerik:RadComboBox ID="cmbAction" runat="server" AutoPostBack="True" Skin="WebBlue">
                        <Items>
                            ...
                            <telerik:RadComboBoxItem Value="1" Text="View PO" />
                            <telerik:RadComboBoxItem Value="2" Text="Update WIP" />
                            <telerik:RadComboBoxItem Value="3" Text="Revised Shipment Date" />
                            <telerik:RadComboBoxItem Value="4" Text="Split a PO" />
                             <telerik:RadComboBoxItem Value="5" Text="View Milestone" />
                        </Items>
                    </telerik:RadComboBox>
                         </ContentTemplate>
                          </asp:UpdatePanel>
                    ...
                    <telerik:RadGrid ID="dgMasterOrderForMerchandiser" runat="server" CellSpacing="0"
                        ...
                        <MasterTableView ShowFooter="True" TableLayout="Auto">
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn HeaderText="Final Pass Qty" AllowFiltering="false" DataField="InspectedQty" DataFormatString="{0:#,##0;(#,##0);0}" DataType="System.Decimal"  Aggregate="Sum" FooterText=" " FooterStyle-Font-Bold="true" FooterStyle-Font-Names="Calibri"
                                    FilterControlWidth="30px" AutoPostBackOnFilter="false" CurrentFilterFunction="equalto"
                                    FilterDelay="4000" ShowFilterIcon="false">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <HeaderStyle Width="7%" HorizontalAlign="Left" Font-Size="Smaller" />
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn HeaderText="Shipped" AllowFiltering="false" DataField="ShippedQty"  Aggregate="Sum" FooterText=" " DataFormatString="{0:#,##0;(#,##0);0}" DataType="System.Decimal" FooterStyle-Font-Bold="true" FooterStyle-Font-Names="Calibri"
                                    FilterControlWidth="30px" AutoPostBackOnFilter="false" CurrentFilterFunction="equalto"
                                    FilterDelay="4000" ShowFilterIcon="false">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <HeaderStyle Width="7%" HorizontalAlign="Left" Font-Size="Smaller" />
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn HeaderText="Cancel" AllowFiltering="false" DataField="POCancelQty" Aggregate="Sum" DataFormatString="{0:#,##0;(#,##0);0}" DataType="System.Decimal" FooterText=" " FooterStyle-Font-Bold="true" FooterStyle-Font-Names="Calibri"
                                    FilterControlWidth="30px" AutoPostBackOnFilter="false" CurrentFilterFunction="equalto"
                                    FilterDelay="4000" ShowFilterIcon="false">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <HeaderStyle Width="7%" HorizontalAlign="Left" Font-Size="Smaller" />
                               ...
                               <telerik:GridBoundColumn HeaderText="Status" DataField="LastStatus" FilterControlWidth="50px"
                                ...
                                <telerik:GridTemplateColumn HeaderText="Select" AllowFiltering="false">
                                 ...
                                 <a   href="javascript:openPopup('WIPEntry.aspx?lPOID=<%# Eval("POID") %>')">Update WIP</a>									
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>
                            </Columns>
                            <EditFormSettings>
