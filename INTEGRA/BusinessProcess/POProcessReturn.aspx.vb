...
Public Class POProcessReturn
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSave.Click
        Try
            ...
            Else
                ...
                SaveData()
                Response.Redirect("POProcessReceiveView.aspx")
            End If
    ...
    Sub SaveData()
        With ObjFPOReturn
            .FPOProcessReturnId = 0
            .ProcessOrderMstID = lPOID
            .ProcessOrderDtlID = lPODetailID
            .POProcessRecvMasterID = lPORecvMasterID
            .POProcessRecvDetailID = lPORecvDetailID
            .UserId = luserid
