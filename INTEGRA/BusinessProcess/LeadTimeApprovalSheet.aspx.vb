...
Public Class LeadTimeApprovalSheet
    ...
    Function LoadData() As ICollection
        Try
            ...
            objDataTable = objLeadTimeApproval.GetLeadTimeApprovalForNewOrder(CLng(Session("Userid")))
            objDataTable1 = objLeadTimeApproval.GetLeadTimeApprovalForRepeatOrder(CLng(Session("Userid")))
    ...
    Protected Sub dgLeadTimeApprovalSheet_ItemCommand(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridCommandEventArgs) Handles dgLeadTimeApprovalSheet.ItemCommand
        Try
            ...
            DirectCast(Me.Page.Master, MasterPage).ShowMessgae("Lead Time Approved Successfully.")
            Dim objDataview As DataView
            objDataview = LoadData()
            Session("objDataView") = objDataview
            BindGrid()
        ...
        End Try
    End Sub
    Protected Sub btnAlreadyApproved_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAlreadyApproved.Click
        Try
            Response.Redirect("LeadTimeAlreadyApproved.aspx?Merchandid=" & CLng(Session("Userid")) & "")
        Catch ex As Exception
