    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            If dt.Rows.Count > 0 Then
                ...
                lblShipmentModee.Text = dt.Rows(0)("Remarks")
                lblBuyerr.Text = dt.Rows(0)("BuyerName")
                lbli.Text = dt.Rows(0)("InvoiceNo")
                LBLLCNO.Text = dt.Rows(0)("LCNO")
          ...
          mail.From = New MailAddress("ERP.noreply@gmail.com")
            ...
            Body = Body + " </table> <br/>" & _
                         "<br/>" & _
                          ...
                          "<b> <font size=5> Shipment Mode :        <font color=darkBlue>" & lblShipmentModee.Text & " </font></font></b><br/>" & _
             "<b> <font size=5> Buyer :        <font color=darkBlue>" & lblBuyerr.Text & " </font></font></b><br/>" & _
"<b> <font size=5> INVOICE NO. :  <font color=darkBlue>" & lbli.Text & " </font></font></b><br/>" & _
"<b> <font size=5> LC NO:<font color=darkBlue>" & LBLLCNO.Text & "</font></font></b><br/>" & _
