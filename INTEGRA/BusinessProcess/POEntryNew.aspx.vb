...
Public Class POEntryNew
    ...
    Sub BindInq()
        cmbInquiry.DataBind()
        cmbInquiry.Items.Insert(0, New ListItem("Select", "0"))
    End Sub
    Sub bindseason()
        Dim dt As DataTable
    ...
    Protected Sub btnShowData_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnShowData.Click
        Try
            ...
            If txtShipmentDate.ValidationDate = "" Then
    ...
    Sub FillGridByStyle()
        ...
        If Not dtStyle Is Nothing Then
            For x = 0 To dtStyle.Rows.Count - 1
                ...
                Dr("DetailShipmentDate") = txtShipmentDate.SelectedDate 'objGeneralcode.GetDateByMonth(txtShipmentDate.Text)
        ...
        If (Not dtPurchaseOrder Is Nothing) Then
            If (dtPurchaseOrder.Rows.Count > 0) Then
                ...
                For x = 0 To dgPurchaseOrder.Items.Count - 1
                    ...
                    Dim txtDetailShipmentDate As RadDatePicker = DirectCast(dgPurchaseOrder.Items(x).FindControl("txtDetailShipmentDate"), RadDatePicker)
                    Dim cmbDetailShipmentMode As DropDownList = CType(dgPurchaseOrder.Items(x).FindControl("cmbDetailShipmentMode"), DropDownList)
                    Dim PODetailID As Long = dtPurchaseOrder.Rows(x)("PurchaseOrderDetailID")
                    If PODetailID > 0 Then
                        txtDetailShipmentDate.SelectedDate = dtPurchaseOrder.Rows(x)("DetailShipmentDate")
                    Else
                        txtDetailShipmentDate.SelectedDate = txtShipmentDate.SelectedDate 'dtPurchaseOrder.Rows(x)("DetailShipmentDate")
                    End If
            ...
            If lPOID > 0 Then
                ...
                Else
                    ...
                    Else
                        If txtShipmentDate.ValidationDate = "" Then
                            DirectCast(Me.Page.Master, MasterPage).ShowMessgae("Shipment date Empty")
                        ElseIf InqDate.ValidationDate = "" Then
                            DirectCast(Me.Page.Master, MasterPage).ShowMessgae("Inq Date Empty")
                        ElseIf txtPlacementDate.ValidationDate = "" Then
    ...
    Sub Save()
        ...
        Response.Redirect("MasterOrderForDataFeederNeww.aspx")
    ...
    Private Sub GetPOMasterValues()
        ...
        Try
            ...
            Dim datee As String = txtShipmentDate.SelectedDate.Value.ToString("yyyy-MM-dd")
            'txtShipmentDatee.SelectedDate = datee
            'Dim startdatee As String = txtShipmentDatee.SelectedDate.Value.ToString("yyyy-MM-dd")
            DtBookexchange = objPurchaseMaster.GetPOForShipRateNewforBOOKED(datee, datee, cmbCurrency.SelectedItem.Text)
            ...
            With objPurchaseMaster
                ...
                .PlacementDate = txtPlacementDate.SelectedDate 'GeneralCode.GetDate(txtPlacementDate.Text)
                .ShipmentDate = txtShipmentDate.SelectedDate 'GeneralCode.GetDate(txtShipmentDate.Text)
                ...
                .Design = ""
                .TimeSpame = GetTimeSpame(txtShipmentDate.SelectedDate, txtPlacementDate.SelectedDate) 'GetTimeSpame(GeneralCode.GetDate(txtShipmentDate.Text), GeneralCode.GetDate(txtPlacementDate.Text))
                ...
                .InqDate = InqDate.SelectedDate 'GeneralCode.GetDate(InqDate.Text)
                ...
                If cmbEnquiryPurpose.SelectedItem.Text = "Buying Meeting" Then
                    .InquiryInitialID = cmbInquiry.SelectedValue
                    .InquiryRepeatlID = 0
                ElseIf cmbEnquiryPurpose.SelectedItem.Text = "General Meeting" Then
                    .InquiryInitialID = 0
                    .InquiryRepeatlID = cmbInquiry.SelectedValue
                Else
                    .InquiryInitialID = 0
                    .InquiryRepeatlID = 0
                End If
                .MasterPO = txtMasterPO.Text
    ...
    Private Sub GetPODetailValues()
        For x = 0 To dgPurchaseOrder.Items.Count - 1
            ...
            With objPurchaseDetail
                ...
                .DetailShipmentDate = txtDetailShipmentDate.SelectedDate 'objGeneralcode.GetDateN(txtDetailShipmentDate.Text)
    ...
    Sub CheckBookedExchangeRate()
        Try
            Dim Shipmentdatee As String = txtShipmentDate.SelectedDate.Value.ToString("yyyy-MM-dd")
            Dim shipdate As Date = txtShipmentDate.SelectedDate
            ...
            'dtBookedRate = ObjBookedExchangeRate.ExistingOfBookedRateForPOO(Shipmentdatee)
    ...
    Protected Sub btnCalculate_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnCalculate.Click
        Try
            ...
            For x = 0 To dgPurchaseOrder.Items.Count - 1
                ...
                Dim cmbDetailShipmentMode As DropDownList = CType(dgPurchaseOrder.Items(x).FindControl("cmbDetailShipmentMode"), DropDownList)
                txtDetailShipmentDate.SelectedDate = txtShipmentDate.SelectedDate 'dtPurchaseOrder.Rows(x)("DetailShipmentDate")
                cmbDetailShipmentMode.SelectedValue = cmbShipmentMode.SelectedValue
            Next
        Catch ex As Exception
        End Try
    End Sub
    ...
    Sub SetValuesCopyMod()
        ...
        Try
            ...
            txtMasterPO.Text = Dt.Rows(0)("MasterPO")
            ...
            txtShipmentDate.SelectedDate = Dt.Rows(0)("ShipmentDate")
            ...
            InqDate.SelectedDate = Dt.Rows(0)("InqDate")
            cmbStage.SelectedValue = Dt.Rows(0)("Stage")
            cmbEnquiryPurpose.SelectedItem.Text = Dt.Rows(0)("InquiryPurpose")
            If cmbStage.SelectedItem.Text = "INITIAL" Then
                BindINITIALINQ()
                cmbInquiry.SelectedValue = Dt.Rows(0)("InquiryInitialID")
                UpcmbInquiry.Update()
            Else
                BindRepeatINQ()
                cmbInquiry.SelectedValue = Dt.Rows(0)("InquiryRepeatlID")
                UpcmbInquiry.Update()
            End If
    ...
    Sub SetValuesEditMod()
        ...
        Try
            ...
            With dtPurchaseOrder
                ...
                .Columns.Add("Remarks", GetType(String))
                .Columns.Add("StyleDetailID", GetType(Long))
                .Columns.Add("DetailShipmentDate", GetType(Date))
                .Columns.Add("DetailShipmentMode", GetType(String))
            End With
            For x = 0 To Dt.Rows.Count - 1
                Dr = dtPurchaseOrder.NewRow()
                ...
                Dr("DetailShipmentDate") = Dt.Rows(x)("DetailShipmentDate")
    ...
    Protected Sub txtPONO_TextChanged(ByVal sender As Object, ByVal e As EventArgs) Handles txtPONO.TextChanged
        If lPOID = 0 Then
            Dim dt As DataTable
            dt = objPurchaseMaster.CheckPO(txtPONO.Text)
    ...
    Protected Sub cmbStage_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles cmbStage.SelectedIndexChanged
        Try
    ...
    Sub BindINITIALINQ()
        ...
        dtInq = objPurchaseMaster.GetInqInitial(cmbEnquiryPurpose.SelectedItem.Text, cmbStage.SelectedItem.Text)
        cmbInquiry.DataSource = dtInq
        cmbInquiry.DataTextField = "StyleNo"
        cmbInquiry.DataValueField = "InquiryStyleID"
        cmbInquiry.DataBind()
        cmbInquiry.Items.Insert(0, New ListItem("Select", "0"))
    ...
    Sub BindRepeatINQ()
        Dim dtInq As DataTable
        dtInq = objPurchaseMaster.GetInqRepeat(cmbEnquiryPurpose.SelectedItem.Text, cmbStage.SelectedItem.Text)
        cmbInquiry.DataSource = dtInq
        cmbInquiry.DataTextField = "StyleNo"
        cmbInquiry.DataValueField = "GeneralInquiryMstID"
        cmbInquiry.DataBind()
        cmbInquiry.Items.Insert(0, New ListItem("Select", "0"))
    ...
    Protected Sub txtMasterPO_TextChanged(sender As Object, e As EventArgs) Handles txtMasterPO.TextChanged
        Try
            Dim txt As String
            If txtMasterPO.Text <> "" Then
                txt = txtMasterPO.Text
                txtPONO.Text = txt
            Else
                txt = ""
                txtPONO.Text = txt
