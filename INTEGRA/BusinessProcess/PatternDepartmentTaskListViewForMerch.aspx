<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="PatternDepartmentTaskListViewForMerch.aspx.vb" Inherits="Integra.PatternDepartmentTaskListViewForMerch" %>
...
<telerik:GridBoundColumn HeaderText="Task No" DataField="TaskNo" AllowFiltering="false" ItemStyle-Font-Bold="true"  ItemStyle-Font-Names ="Calibri" ItemStyle-Font-Size ="Medium" ItemStyle-ForeColor="Blue"
                                ...
                                <telerik:GridBoundColumn HeaderText="Date" DataField="CreatDatee" AllowFiltering="false"
                                ...
                                <telerik:GridBoundColumn HeaderText="Date Time Stamp" DataField="DateTimeStampp" AllowFiltering="true"
                                    FilterControlWidth="70px" ItemStyle-Font-Bold="true"  ItemStyle-Font-Names ="Calibri" ItemStyle-Font-Size ="Medium" ItemStyle-ForeColor="Blue"
                                      AutoPostBackOnFilter="false" CurrentFilterFunction="StartsWith"
                                    FilterDelay="3000" ShowFilterIcon="false">
                                    <ItemStyle HorizontalAlign="Center" />
                                ...
                                <telerik:GridBoundColumn HeaderText="Priority" DataField="Priority" AllowFiltering="false" Visible ="false" 
                                 ...
                                 <telerik:GridBoundColumn HeaderText="Buyer" DataField="Buyer" AllowFiltering="false"
                                   ...
                                   <telerik:GridTemplateColumn HeaderText="View" UniqueName="View" AllowFiltering="false"
                                        Display="false">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="lnkEdit" Font-Underline="false" Text="Update" Enabled="true" NavigateUrl='<%# "PatternDepartmentTaskListEntry.aspx?lPATTERNDEPARTMENTTASKLISTMstid=" &amp; DataBinder.Eval(Container.DataItem,"PATTERNDEPARTMENTTASKLISTMstid")&"&Status=M"%>'
