...
Public Class RejectConOrderSample
    ...
    Sub Edit()
        ...
        If dtMaster.Rows.Count > 0 Then
            ...
            txtstyle.Text = dtMaster.Rows(0)("StyleNo")
            BindSupplier()
        ...
        End If
        Dim dtPrduct As DataTable = ObjSamplingMaster.GetDetailPage1(SamplingMasterID)
        If dtPrduct.Rows.Count > 0 Then
            ...
            For x = 0 To dtPrduct.Rows.Count - 1
                ...
                Dim cmbRejConSample As DropDownList = CType(dgSampleDetail.Items(x).FindControl("cmbRejConSample"), DropDownList)
                ...
                Dr("FabricTypeID") = 0 ' dtPrduct.Rows(x)("FabricTypeID")
                ...
                cmbRejConSample.SelectedValue = dtPrduct.Rows(x)("RejConSample")
                cmbFabricType.SelectedValue = 0 'dtPrduct.Rows(x)("FabricTypeID")
    ...
    Sub BindSupplier()
        Try
            Dim dtSupplier As DataTable = ObjSamplingMaster.getSupplierPage1()
            With cmbsupplier
        ...
        If Session("dtSampleDetail") IsNot Nothing Then
            ...
            If dtSampleDetail.Rows.Count > 0 Then
                For i As Integer = 1 To dtSampleDetail.Rows.Count
                    ...
                    Dim cmbRejConSample As DropDownList = CType(dgSampleDetail.Items(rowIndex).FindControl("cmbRejConSample"), DropDownList)
                    ...
                    dtSampleDetail.Rows(i - 1)("FabricTypeID") = 0 'cmbFabricType.SelectedValue
                    ...
                    dtSampleDetail.Rows(i - 1)("RejConSample") = cmbRejConSample.SelectedValue
        ...
        If Session("dtSampleDetail") IsNot Nothing Then
            ...
            If dtSampleDetail.Rows.Count > 0 Then
                For i As Integer = 0 To dtSampleDetail.Rows.Count - 1
                    ...
                    Dim cmbRejConSample As DropDownList = CType(dgSampleDetail.Items(i).FindControl("cmbRejConSample"), DropDownList)
                    cmbRejConSample.SelectedValue = dtSampleDetail.Rows(i)("SampleType")
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSave.Click
        Try
            ...
            Else
                DirectCast(Me.Page.Master, MasterPage).ShowMessgae(" ")
                SaveData()
                Response.Redirect("RejectConOrderSampleView.aspx")
            End If
    ...
    Sub SaveData()
        ...
        For x = 0 To dgSampleDetail.Items.Count - 1
            ...
            With ObjSamplingDetail
                ...
                End If
                .FabrictypeID = 0 'cmbFabricType.SelectedValue
                ...
                .RejConSample = cmbRejConSample.SelectedValue
