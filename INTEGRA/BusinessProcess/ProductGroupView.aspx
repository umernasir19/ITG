<%@ Page Language="vb"  MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeBehind="ProductGroupView.aspx.vb" Inherits="Integra.ProductGroupView" %>
<%@ Register TagPrefix="Smart" Namespace="SmartControls.Controls" Assembly="SmartControls" %>
 ...
 <td align="right">
     ...
     <telerik:RadButton ID="btnAdd" runat="server" Text="Add Product Group"  width="180" Skin="WebBlue">
                    </telerik:RadButton>
 </td>
 </tr>
<tr><td  >
	   ...
	   PagerOtherPageCssClass="" PageSize="18" RecordCount="0" ShowFooter="True"  
	    ForeColor="White">
							...
							<COLUMNS>
                             ...
                             <ASP:BOUNDCOLUMN HeaderText="TypeID"
									 DataField="TypeID"  Visible ="false" >
                                    <itemstyle horizontalalign="Left" />
								 <headerstyle width="20%" horizontalalign="Left"  />
							</ASP:BOUNDCOLUMN>

							 <ASP:BOUNDCOLUMN HeaderText="Product Group"
                                 ...
                                 <ASP:TEMPLATECOLUMN HeaderText="Edit" Visible ="true" >
									...
									<ITEMTEMPLATE>
<asp:HyperLink id="lnkEdit" Runat="server" NavigateUrl='<%# "ProductGroupEntry.aspx?lTypeID=" &amp; DataBinder.Eval(Container.DataItem,"TypeID")%>' Enabled="true">
											Edit
										</asp:HyperLink> 
</ITEMTEMPLATE>
