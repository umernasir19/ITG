<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master"
    CodeBehind="DPPOView.aspx.vb" Inherits="Integra.DPPOView" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadCodeBlock runat="server" ID="radCodeBlock">
        <script type="text/javascript">
            function showFilterItem() {
                $find('<%=dgPO.ClientID %>').get_masterTableView().showFilterItem();
            }
            function hideFilterItem() {
                $find('<%=dgPO.ClientID %>').get_masterTableView().hideFilterItem();
            }        
        </script>
    ...
    <div>
        <table width="100%">
            <tr>
                <td align="right">
                    <telerik:RadButton ID="btnAddSampling" runat="server" Text="Add PO" Skin="WebBlue">
                    </telerik:RadButton>
                </td>
            </tr>
            <tr>
                <td>
                    <telerik:RadGrid ID="dgPO" runat="server" CellSpacing="0" AutoGenerateColumns="False"
                        Skin="WebBlue" AllowFilteringByColumn="True" AllowPaging="True" GridLines="None"
                        ShowGroupPanel="True" PageSize="50" OnSortCommand="dgPO_SortCommand" OnPageIndexChanged="dgPO_PageIndexChanged"
                        ...
                        <MasterTableView AutoGenerateColumns="false" AllowFilteringByColumn="True" ShowFooter="True"
                            TableLayout="Auto" DataKeyNames="DPPOMstID" GroupLoadMode="Client">
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn HeaderText="Invoice Date" AllowFiltering="false" DataField="InvoiceDateE">
                                ...
                                <telerik:GridBoundColumn HeaderText="Supplier" DataField="SupplierName" AllowFiltering="true"
                                 ...
                                 <telerik:GridBoundColumn HeaderText="Inditex PO No" DataField="InditexPONO" AllowFiltering="true"
                                    FilterControlWidth="50px" AutoPostBackOnFilter="false" CurrentFilterFunction="StartsWith"
                                    FilterDelay="3000" ShowFilterIcon="false">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <HeaderStyle Width="10%" HorizontalAlign="Left" Font-Size="Smaller" />
                                </telerik:GridBoundColumn>
                                 <telerik:GridBoundColumn HeaderText="PO Qty." DataField="TotalPOQty" AllowFiltering="true"
                                    FilterControlWidth="50px" AutoPostBackOnFilter="false" CurrentFilterFunction="StartsWith"
                                    FilterDelay="3000" ShowFilterIcon="false">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <HeaderStyle Width="10%" HorizontalAlign="Left" Font-Size="Smaller" />
                                ...
                                <telerik:GridTemplateColumn HeaderText="View" UniqueName="View" AllowFiltering="false" Display="true">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="lnkEdit" Font-Underline="false" Text="Update" Enabled="true" NavigateUrl='<%# "DPPurchaseOrder.aspx?lDPPOMstID=" &amp; DataBinder.Eval(Container.DataItem,"DPPOMstID")%>'
