<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master"
    CodeBehind="DPPoRecevView.aspx.vb" Inherits="Integra.DPPoRecevView" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <table width="100%">
            <tr>
                <td align="right">
                    <telerik:RadButton ID="btnAddSampling" runat="server" Text="Add Fabric Recv" Skin="WebBlue">
                    </telerik:RadButton>
                </td>
            </tr>
            <tr>
                <td>
                    <telerik:RadGrid ID="dgPOReceive" runat="server" CellSpacing="0" AutoGenerateColumns="False"
                        ...
                        <MasterTableView AutoGenerateColumns="false" AllowFilteringByColumn="True" ShowFooter="True"
                            TableLayout="Auto" DataKeyNames="POReceiveMstID" GroupLoadMode="Client">
                            ...
                            <Columns>
                                <telerik:GridBoundColumn HeaderText="POReceiveMstID" DataField="POReceiveMstID" Display="false">
                                ...
                                <telerik:GridBoundColumn HeaderText="GRNo" DataField="GRNo" AllowFiltering="true"
                                ...
                                <telerik:GridBoundColumn HeaderText="DalNo" DataField="DalNo" AllowFiltering="true"
                                    FilterControlWidth="50px" AutoPostBackOnFilter="false" CurrentFilterFunction="StartsWith"
                                    FilterDelay="3000" ShowFilterIcon="false">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <HeaderStyle Width="20%" HorizontalAlign="Left" Font-Size="Smaller" />
                                ...
                                <telerik:GridTemplateColumn HeaderText="View" UniqueName="View" AllowFiltering="false" Display="true">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="lnkEdit" Font-Underline="false" Text="Update" Enabled="true" NavigateUrl='<%# "DPPoRecev.aspx?lPOReceiveMstID=" &amp; DataBinder.Eval(Container.DataItem,"POReceiveMstID")%>'
