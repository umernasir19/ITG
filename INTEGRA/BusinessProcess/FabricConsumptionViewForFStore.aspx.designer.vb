...
Partial Public Class FabricConsumptionViewForFStore
    ...
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents cmdAddd As Global.Telerik.Web.UI.RadButton
    ...
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents dgVieww As Global.Telerik.Web.UI.RadGrid
End Class
