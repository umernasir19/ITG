<%@ Page Title="Priority View" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master"
    CodeBehind="PriorityView.aspx.vb" Inherits="Integra.PriorityView" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table width="100%">
        <tr>
            <td align="right">
                <telerik:RadButton ID="btnSave" Style="margin-right: 10px;" Visible="true" runat="server"
                    Text="Set Priority" Skin="WebBlue">
                </telerik:RadButton>
            </td>
        </tr>
    </table>
                    ...
                    <div style="width: 920PX; overflow: scroll; height: 700px;">
                        <telerik:RadGrid ID="dgRND" runat="server" CellSpacing="0" AutoGenerateColumns="False"
                            ...
                            <MasterTableView AutoGenerateColumns="false" AllowFilteringByColumn="True" ShowFooter="True"
                                ...
                                <Columns>
                                    <telerik:GridBoundColumn HeaderText="PATTERNDEPARTMENTTASKLISTMstid" DataField="PATTERNDEPARTMENTTASKLISTMstid"
                                        Display="false">
                                    ...
                                    <telerik:GridTemplateColumn ShowFilterIcon="false" HeaderText="S.No" AllowFiltering="false"
                                        ItemStyle-Font-Bold="true" ItemStyle-Font-Names="Calibri" ItemStyle-Font-Size="Medium"
                                    ...
                                    <telerik:GridBoundColumn HeaderText="Task No" DataField="TaskNo" AllowFiltering="false"
                                        ItemStyle-Font-Bold="true" ItemStyle-Font-Names="Calibri" ItemStyle-Font-Size="Medium"
                                        ItemStyle-ForeColor="Blue" FilterControlWidth="70px" AutoPostBackOnFilter="false"
                                    ...
                                    <telerik:GridBoundColumn HeaderText="Type" DataField="Typee" AllowFiltering="false"
                                        ...
                                        ItemStyle-Font-Size="Medium" ItemStyle-ForeColor="Blue" AutoPostBackOnFilter="false"
                                        CurrentFilterFunction="StartsWith" FilterDelay="3000" ShowFilterIcon="false">
                                        <ItemStyle HorizontalAlign="Center" />
                                    ...
                                    <telerik:GridBoundColumn HeaderText="Style" DataField="Style" AllowFiltering="false"
                                        FilterControlWidth="50px" ItemStyle-Font-Bold="true" ItemStyle-Font-Names="Calibri"
                                        ItemStyle-Font-Size="Large" ItemStyle-ForeColor="Blue" AutoPostBackOnFilter="false"
                                        CurrentFilterFunction="StartsWith" FilterDelay="3000" ShowFilterIcon="false">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <HeaderStyle Width="20%" HorizontalAlign="Center" Font-Size="Smaller" />
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridBoundColumn HeaderText="User" DataField="UserName" AllowFiltering="false"
                                        FilterControlWidth="50px" ItemStyle-Font-Bold="true" ItemStyle-Font-Names="Calibri"
                                        ItemStyle-Font-Size="Large" ItemStyle-ForeColor="Red" AutoPostBackOnFilter="false"
                                        CurrentFilterFunction="StartsWith" FilterDelay="3000" ShowFilterIcon="false">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <HeaderStyle Width="20%" HorizontalAlign="Center" Font-Size="Smaller" />
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn HeaderText="Date" DataField="CreationDate" AllowFiltering="false"
                                        FilterControlWidth="70px" ItemStyle-Font-Bold="true" ItemStyle-Font-Names="Calibri"
                                        ItemStyle-Font-Size="Medium" ItemStyle-ForeColor="Blue" AutoPostBackOnFilter="false"
                                        CurrentFilterFunction="StartsWith" FilterDelay="3000" ShowFilterIcon="false">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <HeaderStyle Width="20%" HorizontalAlign="Center" Font-Size="Smaller" />
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn HeaderText="Date Time Stamp" DataField="DateTimeStampp"
                                        AllowFiltering="false" Display="false" FilterControlWidth="70px" ItemStyle-Font-Bold="true"
                                        ItemStyle-Font-Names="Calibri" ItemStyle-Font-Size="Medium" ItemStyle-ForeColor="Blue"
                                    ...
                                    <telerik:GridBoundColumn HeaderText="Con Status" DataField="ConStatus" UniqueName="ConStatus"
                                        ItemStyle-Font-Bold="true" ItemStyle-Font-Size="Large" ItemStyle-Font-Names="Calibri"
                                        ItemStyle-ForeColor="Red" Display="true" AllowFiltering="false">
                                        <ItemStyle HorizontalAlign="Center" />
                                        <HeaderStyle Width="2%" HorizontalAlign="Left" />
                                    </telerik:GridBoundColumn>
                                    <telerik:GridTemplateColumn HeaderText="Priority" UniqueName="Priority" AllowFiltering="false">
                                        <ItemStyle Width="5%" HorizontalAlign="Left"></ItemStyle>
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtPriority" AutoPostBack="FALSE" onkeypress="return isNumericKeyy(event);"
                                                runat="server" Width="60" CssClass="textbox"></asp:TextBox>
                                        </ItemTemplate>
                            ...
                            <PagerStyle PageSizeControlType="RadComboBox" Position="TopAndBottom" Visible="false">
                            </PagerStyle>
