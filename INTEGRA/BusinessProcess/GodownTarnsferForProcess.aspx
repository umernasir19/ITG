<%@ Page Title="Godown Tarnsfer" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master"
    CodeBehind="GodownTarnsferForProcess.aspx.vb" Inherits="Integra.GodownTarnsferForProcess" %>
            ...
            <td style="width: 130px;">
                <div class="text_box" style="margin-left: 5px;">
                    ...
                    <cc1:AutoCompleteExtender ID="AutoCompleteExtender2" runat="server" CompletionInterval="10"
                        CompletionSetCount="12" ContextKey="ItemCodeForGodownSearchForProcess" EnableCaching="true"
