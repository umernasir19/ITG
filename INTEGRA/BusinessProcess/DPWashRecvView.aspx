<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="DPWashRecvView.aspx.vb" Inherits="Integra.DPWashRecvView" %>
...
<telerik:RadWindowManager ID="RadWindowManager1" runat="server">
 ...
 <table width ="100%">
            <tr>
                <td align="right">
                    <telerik:RadButton ID="btnAddWashIssue" runat="server" Text="Add Wash Recv" Skin="WebBlue">
                    </telerik:RadButton>
                </td>
            </tr>
            <tr>
                <td>
                    <telerik:RadGrid ID="dgSampleReceive" runat="server" CellSpacing="0" AutoGenerateColumns="False"
                        ...
                        <MasterTableView AutoGenerateColumns="false" AllowFilteringByColumn="True" ShowFooter="True"
                            TableLayout="Auto" DataKeyNames="DPWashRecvMstID" GroupLoadMode="Client">
                            ...
                            <Columns>
                                <telerik:GridBoundColumn HeaderText="DPWashRecvMstID" DataField="DPWashRecvMstID" Display="false">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <HeaderStyle Width="2%" HorizontalAlign="Left" />
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn HeaderText="Receive Date" AllowFiltering="false" DataField="RecvDatee">
                                    <HeaderStyle Width="9%" HorizontalAlign="center" />
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn HeaderText="Wash No" DataField="WashRecvNo" AllowFiltering="true"
                                    ...
                                    <telerik:GridBoundColumn HeaderText="Wash Type" DataField="WashType" AllowFiltering="true"
                                    FilterControlWidth="50px" AutoPostBackOnFilter="false" CurrentFilterFunction="StartsWith"
                                    FilterDelay="3000" ShowFilterIcon="false">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <HeaderStyle Width="20%" HorizontalAlign="Left" Font-Size="Smaller" />
                              ...
                              <telerik:GridBoundColumn HeaderText="Recv Qty" DataField="ReceiveQuantity" AllowFiltering="false"
                                    FilterControlWidth="50px" AutoPostBackOnFilter="false" CurrentFilterFunction="StartsWith"
                                    FilterDelay="3000" ShowFilterIcon="false">
                                    <ItemStyle HorizontalAlign="Left" />
                            ...
                            <telerik:GridTemplateColumn HeaderText="View"  UniqueName="View" AllowFiltering="false" Display="True">
                                <ItemTemplate>
                                    <asp:HyperLink ID="lnkEdit" Font-Underline="false" Text="Update" Enabled="true" CommandName="EDIT"
                                        NavigateUrl='<%# "DPWashReceive.aspx?DPWashRecvMstID=" &amp; DataBinder.Eval(Container.DataItem,"DPWashRecvMstID")%>'
                                        runat="server"></asp:HyperLink>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
