<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="QualityDepartmentForManagement.aspx.vb" Inherits="Integra.QualityDepartmentForManagement" %>
<%@ Register TagPrefix="Smart" Namespace="SmartControls.Controls" Assembly="SmartControls" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Quality Department Inspection History</title>
...
<body>
 ...
 <tr>
            ...
            <tr>
            <td>
            <SMART:SMARTDATAGRID id="dgQDInspectionHistory" runat="server" width="100%" CssClass="tablemultigrid"  OnSortCommand="SortByColumn" OnPageIndexChanged="PageChanged" AutoGenerateColumns="False" CellPadding="3"   SortedAscending="yes" ForeColor="White" GridLines="both" PagerCurrentPageCssClass="" PagerOtherPageCssClass="" PageSize="25" RecordCount="0" AllowPaging="True" AllowSorting="True" ShowFooter="True">
							<COLUMNS>
                                ...
                                <ASP:BOUNDCOLUMN HeaderText="Inspection Date"  DataField="InspectionDate" >
                                   ...
                                   <headerstyle horizontalalign="Left" width="14%" />
                                	...
                                	<ASP:BOUNDCOLUMN HeaderText="Article No"   DataField="Article" >
                                   <headerstyle horizontalalign="Left" width="14%" />
                                    <itemstyle horizontalalign="Left" />
                                </ASP:BOUNDCOLUMN>
