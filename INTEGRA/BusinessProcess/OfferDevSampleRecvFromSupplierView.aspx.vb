...
Imports System.IO
Public Class OfferDevSampleRecvFromSupplierView
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            End Try
        End If
        PageHeader("Off/Development Sample Received From Supplier")
    End Sub
    ...
    Function LoadData() As ICollection
        ...
        objDataTable = OBJSamplingMaster.GetDataForView(1)
    ...
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnAdd.Click
        Response.Redirect("OfferDevSampleRecvFromSupplier.aspx")
    End Sub
