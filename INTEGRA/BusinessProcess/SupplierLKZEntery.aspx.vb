...
Public Class SupplierLKZEntery
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            PageHeader("Supplier LKZ Number Entry Panel")
            BindBuyerWise()
            BindSupplierWise()
        End If
    End Sub
    ...
    Public Sub SaveInSession()
        ...
        Else
            ...
            With dtLKZ
                With dtLKZ
                    .Columns.Add("LKZid", GetType(Long))
                    ...
                    .Columns.Add("LKZNumber", GetType(String))
                End With
            End With
        End If
        dr = dtLKZ.NewRow()
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Try
            Dim LKZID, SupplierID, CustomerID, LKZNumber As String
            Dim x As Integer
            Dim dtCheck As New DataTable
            If dgLKZz.Items.Count > 0 Then
                For x = 0 To dgLKZz.Items.Count - 1
                    LKZID = dgLKZz.Items(x).Cells(0).Text
                    ...
                    dtCheck = objSupplierLKZ.CheckExistingOfLKZNumber(SupplierID, CustomerID)
                    ...
                    Else
                        ...
                        End With
                        Response.Redirect("SupplierLKZView.aspx")
                    End If
                Next
            Else
                'Not Save
