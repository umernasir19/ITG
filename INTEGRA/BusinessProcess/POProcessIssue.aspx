<%@ Page Title="Process Issue" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="POProcessIssue.aspx.vb" Inherits="Integra.POProcessIssue" %>
    ...
    <asp:AsyncPostBackTrigger ControlID="cmbJobNo"  EventName="SelectedIndexChanged" />
                ...
                <tr style="height: 30px;">
                    ...
                    <td>
                        <div class="text_box" style="width: 130px; margin-left: 10px;">
                            <asp:TextBox ID="txtCreationDate" CssClass="textbox" Width="129" runat="server" AutoPostBack="false"
                                Style="text-transform: uppercase; margin-left: -4px; height: 20px; margin-top: 10px;"></asp:TextBox></div>
                        ...
                        <asp:ImageButton runat="Server" ID="ImageButton1" CausesValidation="false" ImageUrl="~/Images/callendar.JPG"
                            AlternateText="Click here to display calendar" Style="margin-left: 138px; margin-top: -9px;" />
                    ...
                    <td style="width: 118px;">
                        <div class="txt" style="width: 125px;     margin-left: -85px;">
                            Already Issued:</div>
                    </td>
                    <td>
                        <div class="text_box" style="width: 120px; margin-left: 10px;">
                            <asp:TextBox ID="txtAlreadyIssued" CssClass="textbox" runat="server" ReadOnly="true"
                                Visible="true" Style="background-color: #6495ED; height: 20px; width: 144px; margin-left: -67px;"></asp:TextBox></div>
                    </td>


                      <td style="width: 118px; margin-left:0px;">
                        <div id="Div1" runat="server" class="txt" style ="width: 124px;">
                            Issue:</div>
                    </td>
                    <td style="width: 160px;">
                        <div class="text_box" style="width: 130px; margin-left: 10px;">
                            <asp:TextBox ID="txtIssue" CssClass="textbox" runat="server" AutoPostBack="true"
                                  Style="height: 20px;  margin-left: -7px;" ReadOnly="false" onkeypress="return isNumericKeyy(event);"></asp:TextBox></div>
                    </td>
                ...
                <tr style="height: 34px;">
                    <td style="width: 118px;">
                     ...
                     <td>
                        ...
                        <asp:TextBox ID="txtItemCode" runat="server" autocomplete="off" AutoPostBack="true" Style="margin-left: 11px; width: 153px;"></asp:TextBox>
                                     <cc1:AutoCompleteExtender ID="AutoCompleteExtender2" runat="server" CompletionInterval="10"
                                        CompletionSetCount="12" ContextKey="ItemCodeForProcessIssueNew" EnableCaching="true" MinimumPrefixLength="1"
                ...
                <tr style="height: 34px;">
                  ...
                  <td style="width: 118px;">
                    ...
                    <td id="tdcmbPONO" runat="server" style="width: 160px;">
                        <asp:DropDownList ID="cmbPoNo" AutoPostBack="True" Visible ="true"  CssClass="combo" Width="160px"
                    ...
                    runat="server" TabIndex="0" style="  margin-left: -42px;">
                        ...
                        <div class="text_box" style="width: 130px; margin-left: 10px;">
                            <asp:TextBox ID="txtContractor" CssClass="textbox" runat="server" ReadOnly="false"
                                Style="height: 20px;  margin-left: 0px;     width: 144px;"></asp:TextBox></div>
                    </td>
                  
                    <td style="width: 160px;">
                        <div class="text_box" style="width: 130px; margin-left: 10px;">
                            <asp:TextBox ID="txtEntryType" CssClass="textbox" Visible ="false" runat="server" ReadOnly="false"
                 ...
                 <td style="width: 118px;">
                    ...
                    <td style="width: 160px;">
                        <div class="text_box" style="width: 130px; margin-left: 10px;">
                          ...
                          <asp:ImageButton ID="BtnAddGodwn" runat="server" ImageUrl="~/Images/AddButton.jpg" Style="margin-left: 168px;
                            width: 19px; margin-top :-19px;" />   
                    </td>
                    </asp:Panel> 
                    ...
                    <td style="width: 160px;">
                        <div class="text_box" style="width: 130px; margin-left: 10px;">
                            <asp:TextBox ID="txtGodown" CssClass="textbox" runat="server" ReadOnly="false"
                                Style="margin-left: 0px; height: 20px; width: 150px;"></asp:TextBox>
                        </div>
                    ...
                    <td>
                        <Smart:SmartDataGrid ID="dgAdd" runat="server" Width="100%" AllowPaging="True" AllowSorting="True"
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn ItemStyle-HorizontalAlign="Left" Visible ="false"  HeaderStyle-Width="10%" HeaderText="Entry Type"
                                    DataField="EntryType">
                                    <ItemStyle HorizontalAlign="Center" />
