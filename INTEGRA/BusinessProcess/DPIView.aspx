<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="DPIView.aspx.vb" Inherits="Integra.DPIView" %>
                        ...
                        <MasterTableView AutoGenerateColumns="false" AllowFilteringByColumn="True" ShowFooter="True"
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn HeaderText="Season Name" DataField="SeasonName" AllowFiltering="true"
                                    ...
                                    FilterDelay="3000" ShowFilterIcon="false">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <HeaderStyle Width="13%" HorizontalAlign="Left" Font-Size="Smaller" />
                                </telerik:GridBoundColumn>


                                
                                <telerik:GridBoundColumn HeaderText="ReportTypeID" DataField="ReportTypeID" Display="false">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <HeaderStyle Width="2%" HorizontalAlign="Left" />
                                </telerik:GridBoundColumn>
                             ...
                             <telerik:GridTemplateColumn HeaderText="View" UniqueName="View" AllowFiltering="false" Display="true">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="lnkEdit" Font-Underline="false" Text="Update" Enabled="true" NavigateUrl='<%# "DPIAdd.aspx?lDPIMstID=" &amp; DataBinder.Eval(Container.DataItem,"DPIMstID")%>'
                                ...
                                <telerik:GridTemplateColumn ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="01%"
                                 ...
                                 <telerik:GridTemplateColumn ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="01%"
                                    HeaderText="Without Header PDF" Visible="true" AllowFiltering="false">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="lnkPDFF" ToolTip="Click here to download PDF" ImageUrl="~/Images/pdfIcon.png"
