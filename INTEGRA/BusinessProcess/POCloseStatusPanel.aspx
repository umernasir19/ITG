<%@ Page Language="vb" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeBehind="POCloseStatusPanel.aspx.vb" Inherits="Integra.POCloseStatusPanel" %>
                            ...
                            <Columns>
                               ...
                               <telerik:GridBoundColumn HeaderText="Status" DataField="LastStatus" FilterControlWidth="50px"
                                 ...
                                 <telerik:GridTemplateColumn HeaderText="Select" AllowFiltering="false">
                                    <ItemTemplate>
                             <a   href="javascript:openPopup('POCloseStatusPopup.aspx?lPOID=<%# Eval("POID") %>')">Close PO</a>									
                                    </ItemTemplate>
                                        <HeaderStyle Width="5%" HorizontalAlign="Left" Font-Size="Smaller" />
