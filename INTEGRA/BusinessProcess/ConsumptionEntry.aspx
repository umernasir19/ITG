<%@ Page Title="Consumption Entry" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="ConsumptionEntry.aspx.vb" Inherits="Integra.ConsumptionEntry" %>
 ...
 <script type="text/javascript">
    ...
    <td>
            ...
            <td>
                 <div class="text_box" style="width: 130px;">
                    <asp:TextBox CssClass="textbox" ID="txtSeason" style="height :20px;" runat="server" ReadOnly="True"></asp:TextBox></div>
            </td>
            ...
            <td> <div class="text_box" style="width: 130px;">
                <asp:TextBox CssClass="textbox" ID="txtCustomer" style="height :20px;" runat="server" ReadOnly="True"></asp:TextBox></div>
            </td>
    </tr>
        <tr>
        ...
        <tr style ="height :34px;">
            ...
            <td>
             <div class="text_box" style="width: 130px;">
                <asp:TextBox CssClass="textbox" ID="txtOrderNo" style="height :20px;" runat="server" ReadOnly="True"></asp:TextBox>
                </div> 
            </td>
            <td>
                <div class="txt" style ="width :130px;  margin-left: 30px; margin-top: -3px;">
            ...
            <td>
             <div class="text_box" style="width: 130px;">
                <asp:TextBox ID="txtFabricRecvDate" CssClass="textbox"  style="height :20px;" runat="server" ReadOnly="false"></asp:TextBox>
                </div> 
            <cc1:CalendarExtender ID="CalendarExtender2" Format="dd/MM/yyyy" runat="server" TargetControlID="txtFabricRecvDate"
                    ...
                    <asp:ImageButton runat="Server" ID="ImageButton2" CausesValidation="false" ImageUrl="~/Images/callendar.jpg"
                        AlternateText="Click here to display calendar" Style="margin-left:34px; margin-top: 4px; margin-bottom: -5px;" />
        ...
        <tr>
            ...
            <td>
              <asp:DropDownList ID="cmbSupplier" Width="160px" CssClass="combo" runat="server" AutoPostBack="false" height="26px"
                        Visible="true">
                    </asp:DropDownList>
            </td>
              ...
              <Smart:SmartDataGrid ID="dgView" runat="server" Width="100%" 
                   AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn ItemStyle-HorizontalAlign="center" HeaderStyle-Width="12%" HeaderText="Quantity"
                         ...
                         <asp:TemplateColumn HeaderText="Est Con">
                            ...
                            <ItemTemplate>
                                <asp:TextBox ID="txtEstCon" runat="server" Width="60" CssClass="textbox" 
                                    AutoPostBack="false" style="text-transform :uppercase ;" onkeypress="return isNumericKeyy(event);"></asp:TextBox>
                              </ItemTemplate>
                            ...
                            <ItemStyle Width="5%" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                <asp:TextBox ID="txtOrderCon" runat="server" Width="60" CssClass="textbox" 
                                    AutoPostBack="false" style="text-transform :uppercase ;" onkeypress="return isNumericKeyy(event);"></asp:TextBox>
                              </ItemTemplate>
                            <HeaderStyle Width="6%" HorizontalAlign="Center"></HeaderStyle>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="Act Con">
                            <ItemStyle Width="5%" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                <asp:TextBox ID="txtActCon" runat="server" Width="60" CssClass="textbox" 
                                    AutoPostBack="false" style="text-transform :uppercase ;" onkeypress="return isNumericKeyy(event);"></asp:TextBox>
                              </ItemTemplate>
                            <HeaderStyle Width="6%" HorizontalAlign="Center"></HeaderStyle>
                        </asp:TemplateColumn>
                          ...
                          <asp:TemplateColumn HeaderText="Fabric Req Qty">
                            ...
                            <ItemTemplate>
                                <asp:TextBox ID="txtFabricReqQty" runat="server" Width="40" CssClass="textbox" 
                                    AutoPostBack="false" style="text-transform :uppercase ;" onkeypress="return isNumericKeyy(event);"></asp:TextBox>
                              </ItemTemplate>
                         ...
                         <asp:TemplateColumn HeaderText="Balance Qty" Visible ="false">
                            <ItemStyle Width="4%" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                <asp:TextBox ID="txtBalanceQty" runat="server" Width="40" CssClass="textbox" 
                                    AutoPostBack="false" style="text-transform :uppercase ;" onkeypress="return isNumericKeyy(event);"></asp:TextBox>
                              </ItemTemplate>
                            <HeaderStyle Width="4%" HorizontalAlign="Center"></HeaderStyle>
                        </asp:TemplateColumn>
                    ...
                    <asp:ImageButton runat="Server" ID="ImageButton4" CausesValidation="false" ImageUrl="~/Images/callendar.jpg"
                        AlternateText="Click here to display calendar" Style="margin-left:0px; margin-top: -1px; margin-bottom: -5px;" />
                    <cc1:MaskedEditExtender ID="MaskedEditExtender4" runat="server" TargetControlID="txtInspectionDate"
                        ...
                        Enabled="True" UserDateFormat="DayMonthYear" AutoComplete="False">
                         ...
                         <asp:TemplateColumn HeaderText="Packing" Visible="false" >
                            <ItemStyle Width="5%" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                <asp:TextBox ID="txtPacking" runat="server" Width="40" CssClass="textbox" 
                                    AutoPostBack="false" style="text-transform :uppercase ;" onkeypress="return isNumericKeyy(event);"></asp:TextBox>
                              </ItemTemplate>
                            <HeaderStyle Width="4%" HorizontalAlign="Center"></HeaderStyle>
                        </asp:TemplateColumn>
                         <asp:TemplateColumn HeaderText="Length" Visible="false">
                            <ItemStyle Width="4%" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                <asp:TextBox ID="txtLength" runat="server" Width="40" CssClass="textbox" 
                                    AutoPostBack="false" style="text-transform :uppercase ;" onkeypress="return isNumericKeyy(event);"></asp:TextBox>
                              </ItemTemplate>
                            <HeaderStyle Width="4%" HorizontalAlign="Center"></HeaderStyle>
                        </asp:TemplateColumn>
                         <asp:TemplateColumn HeaderText="Width" Visible="false">
                            <ItemStyle Width="4%" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                <asp:TextBox ID="txtWidth" runat="server" Width="40" CssClass="textbox" 
                                    AutoPostBack="false" style="text-transform :uppercase ;" onkeypress="return isNumericKeyy(event);"></asp:TextBox>
                              </ItemTemplate>
                            <HeaderStyle Width="4%" HorizontalAlign="Center"></HeaderStyle>
                        </asp:TemplateColumn>
                         <asp:TemplateColumn HeaderText="Height" Visible="false">
                            <ItemStyle Width="4%" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                <asp:TextBox ID="txtHeight" runat="server" Width="40" CssClass="textbox" 
                                    AutoPostBack="false" style="text-transform :uppercase ;" onkeypress="return isNumericKeyy(event);"></asp:TextBox>
                              </ItemTemplate>
                            <HeaderStyle Width="4%" HorizontalAlign="Center"></HeaderStyle>
                        </asp:TemplateColumn>
    ...
    <td>
     <asp:Button ID="btnSave"  runat="server"
                        Text="Save" Style="margin-left: 0px;" />
    </td>

    <td>
     <asp:Button ID="btnCancel"  runat="server"
                        Text="Cancel" Style="margin-left: 0px;" />
    </td>
    </tr>
    </table>
