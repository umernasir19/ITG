<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master"
    CodeBehind="GIACodingCustomerEntry.aspx.vb" Inherits="Integra.GIACodingCustomerEntry" %>
        ...
        <tr>
            <td>
                <Smart:SmartDataGrid ID="dgLKZz" OnPageIndexChanged="PageChanged" runat="server"
                    ...
                    <Columns>
                        <asp:BoundColumn HeaderText="GIACodingCustomerID" DataField="GIACodingCustomerID"
                            Visible="False" />
