<%@ Page Title="Fabric DB View" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master"
    CodeBehind="DPFabricDBView.aspx.vb" Inherits="Integra.DPFabricDBView" %>
   ...
   <%-- <table>
       <tr style="border-bottom-style: solid; border-bottom-color: #00509F; border-bottom-width: thin;"
            ...
            <th colspan="6" align="left" style="font-family:Century Gothic ; font-size: 16PX; font-weight: bold;
                color:Blue ">
             <marquee > Find Maximum Dal No</marquee>
            </th>
        </tr>
        <tr>
        <td align="center" style="width: 100px; height: 30px;">
                <asp:Label ID="LBL1" runat="server" Text="DYED:"  style=" margin-left: -51px; font-family:Calibri; font-size: 16PX; font-weight: bolder ;
                color:Chocolate  "
             ...
             <td align="center" style="width: 128px; height: 30px;">
                <asp:Label ID="LBLdYED" runat="server"    Font-Underline ="true"  style="  margin-left: -141px; font-family:Calibri; font-size: 14PX; font-weight: bolder ;
                color:Red   "></asp:Label>
            </td>
               <td align="center" style="width: 100px; height: 30px;">
                <asp:Label ID="Label2" runat="server" Text="DENIM:" style=" margin-left: -65px; font-family:Calibri; font-size: 16PX; font-weight: bolder ;
                color:Chocolate    "
                    Font-Size="Medium"></asp:Label>
            </td>

                 <td align="center" style="width: 128px; height: 30px;">
                <asp:Label ID="LBLDenim" runat="server"    Font-Underline ="true" style="     margin-left: -103px; font-family:Calibri; font-size: 14PX; font-weight: bolder ;
                color:Red   "></asp:Label>
            </td>
    ...
    <tr>
    <td align="center" style="width: 128px; height: 30px;">
                <asp:Label ID="Label20" runat="server" Text="Type" Font-Names="Calibri" Font-Size="Medium" STYLE=" MARGIN-LEFT: -87PX;"></asp:Label>
            </td>
            <td >
