<%@ Page Language="vb" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeBehind="SamplingChartHistory.aspx.vb" Inherits="Integra.SamplingChartHistory" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <table><tr style="font-family: Arial; font-size: 16PX; font-weight: bold; color: #00509F;" visible="true"; ><td valign ="middle"  style="height:40px;">
         ...
         <table width="100%">
            <tr>
            <td><telerik:RadGrid ID="dgprocessHistory" runat="server" CellSpacing="0" 
           ...
           <ItemStyle HorizontalAlign="Left" />
            ...
            <HeaderStyle Width="10%" HorizontalAlign="center" />
              ...
              <telerik:GridBoundColumn HeaderText="Submission" DataField="Submission">
            <ItemStyle HorizontalAlign="Left" />
            <HeaderStyle Width="10%" HorizontalAlign="center" />
            </telerik:GridBoundColumn>            
