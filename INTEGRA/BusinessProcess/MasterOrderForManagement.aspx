<%@ Page Language="vb" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeBehind="MasterOrderForManagement.aspx.vb" Inherits="Integra.MasterOrderForManagement" %>
              ...
              <asp:UpdatePanel ID="upcmbAction" UpdateMode="Conditional" runat="server">
                    ...
                    <telerik:RadComboBox ID="cmbAction" runat="server" AutoPostBack="True" Skin="WebBlue">
                        <Items>
                            ...
                            <telerik:RadComboBoxItem Value="3" Text="View Inspections" />
                                                </Items>
                    </telerik:RadComboBox>
                                 </ContentTemplate>
                          </asp:UpdatePanel>
                       ...
                       ShowStatusBar="true" StatusBarSettings-ReadyText="Loading" OnPageIndexChanged="dgMasterOrderForManagement_PageIndexChanged"
                        ...
                        <MasterTableView ShowFooter="True" TableLayout="Auto">
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn HeaderText="Inspected" DataField="InspectedQty" AllowFiltering="false" Aggregate="Sum" FooterText=" " FooterStyle-Font-Bold="true" FooterStyle-Font-Names="Calibri">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <HeaderStyle Width="7%" HorizontalAlign="Left" Font-Size="Smaller" />
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn HeaderText="Shipped" DataField="ShippedQty" AllowFiltering="false" Aggregate="Sum" FooterText=" " FooterStyle-Font-Bold="true" FooterStyle-Font-Names="Calibri">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <HeaderStyle Width="7%" HorizontalAlign="Left" Font-Size="Smaller" />
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn HeaderText="Claim Pcs." DataField="ClaimQty" AllowFiltering="false" Aggregate="Sum" FooterText=" " FooterStyle-Font-Bold="true" FooterStyle-Font-Names="Calibri">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <HeaderStyle Width="7%" HorizontalAlign="Left" Font-Size="Smaller" />
                                </telerik:GridBoundColumn>
                                ...
                                <telerik:GridBoundColumn HeaderText="Shipped Value" DataField="ShippedValue" AllowFiltering="false">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <HeaderStyle Width="7%" HorizontalAlign="Left" Font-Size="Smaller" />
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn HeaderText="Commission" DataField="Commission" AllowFiltering="false">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <HeaderStyle Width="7%" HorizontalAlign="Left" Font-Size="Smaller" />
                                </telerik:GridBoundColumn>
