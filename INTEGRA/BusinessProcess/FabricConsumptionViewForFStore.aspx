<%@ Page Title="Fabric Consumption View" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master"
    CodeBehind="FabricConsumptionViewForFStore.aspx.vb" Inherits="Integra.FabricConsumptionViewForFStore" %>
                        ...
                        <telerik:RadGrid ID="dgVieww" runat="server" CellSpacing="0" AutoGenerateColumns="False"
                            ...
                            <MasterTableView AutoGenerateColumns="false" AllowFilteringByColumn="True" ShowFooter="True"
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn HeaderText="TypeID" AllowFiltering="false" DataField="TypeID"
                                     ...
                                     <telerik:GridBoundColumn HeaderText="Con Date" UniqueName="ConDate" DataField="ConDate" AllowFiltering="true"
                                        ...
                                        <HeaderStyle Width="5%" HorizontalAlign="Left" Font-Size="Smaller" />
                                         ...
                                         <telerik:GridBoundColumn HeaderText="Type" UniqueName="Type" DataField="FabricConsumptionType" AllowFiltering="true"
                                        FilterControlWidth="30px" AutoPostBackOnFilter="false" CurrentFilterFunction="StartsWith"
                                        FilterDelay="2000" ShowFilterIcon="false">
                                        <ItemStyle HorizontalAlign="Left" />
                                        <HeaderStyle Width="5%" HorizontalAlign="Left" Font-Size="Smaller" />
                                    ...
                                    <telerik:GridBoundColumn HeaderText="Date" Visible ="false"  DataField="CreationDatee" AllowFiltering="true"
                                        FilterControlWidth="50px" AutoPostBackOnFilter="false" CurrentFilterFunction="StartsWith"
                                        FilterDelay="3000" ShowFilterIcon="false">
                                        <ItemStyle HorizontalAlign="Left" />
                                    ...
                                    <telerik:GridBoundColumn HeaderText="Finished Fabric Width" DataField="FinishedFabricWidth"
                                        AllowFiltering="true" FilterControlWidth="50px" AutoPostBackOnFilter="false"
                                        CurrentFilterFunction="StartsWith" FilterDelay="3000" ShowFilterIcon="false">
                                        <ItemStyle HorizontalAlign="Left" />
                                        <HeaderStyle Width="10%" HorizontalAlign="Left" Font-Size="Smaller" />
                                    </telerik:GridBoundColumn>
                                      <telerik:GridBoundColumn HeaderText="Ratio" Visible ="false"  DataField="Ratio"
                                        AllowFiltering="true" FilterControlWidth="50px" AutoPostBackOnFilter="false"
                                        CurrentFilterFunction="StartsWith" FilterDelay="3000" ShowFilterIcon="false">
                                        <ItemStyle HorizontalAlign="Left" />
                                        <HeaderStyle Width="10%" HorizontalAlign="Left" Font-Size="Smaller" />
                                     ...
                                     <telerik:GridBoundColumn HeaderText="Ratio" DataField="Ratioo"
                                        AllowFiltering="true" FilterControlWidth="50px" AutoPostBackOnFilter="false"
                                        CurrentFilterFunction="StartsWith" FilterDelay="3000" ShowFilterIcon="false">
                                        <ItemStyle HorizontalAlign="Left" />
                                        <HeaderStyle Width="10%" HorizontalAlign="Left" Font-Size="Smaller" />
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="View" UniqueName="View" AllowFiltering="false"
                                        Display="true">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="lnkEdit" Font-Underline="false" Text="Update" Enabled="true" NavigateUrl='<%# "FabricConsumption.aspx?lFabricConsumptionID=" &amp; DataBinder.Eval(Container.DataItem,"FabricConsumptionID")&"&Status=1"%>'
                                                runat="server"></asp:HyperLink>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                    <telerik:GridTemplateColumn ItemStyle-HorizontalAlign="Center" AllowFiltering="false"
                                        HeaderStyle-Width="02%" HeaderText="PDF" Visible="true">
                                        <ItemTemplate>
