<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="CPSRequirmenEntry.aspx.vb" Inherits="Integra.CPSRequirmenEntry" %>
    ...
    <table width="40%">
     <tr >
            <th colspan="6" align="left" style="font-family: 'Times New Roman', Times, serif;
                ...
                bgcolor="Silver">
               Critical Path Supplier End Requirment
            </th>
        </tr>
