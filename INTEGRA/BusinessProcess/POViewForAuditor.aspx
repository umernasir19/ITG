<%@ Page Title="PO View" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master"
    CodeBehind="POViewForAuditor.aspx.vb" Inherits="Integra.POViewForAuditor" %>
        ...
        <tr>
            ...
            <td style="width: 150px;">
                ...
                <cc1:AutoCompleteExtender runat="server" ID="AutoCompleteExtender1" TargetControlID="txtSummarySearch"
                    ...
                    CompletionInterval="10" EnableCaching="true" CompletionSetCount="12" ContextKey="GetPoEntrySearchingForAuditor" />
            </td>
             <td>
              ...
              <div style="width: 920PX; overflow: scroll; HEIGHT: 350PX;" >
                <Smart:SmartDataGrid ID="dgSummaryView" runat="server" Width="100%" OnSortCommand="SortByColumnSummary"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn ItemStyle-HorizontalAlign="center" HeaderStyle-BackColor="#04A4BD" HeaderStyle-ForeColor ="Black" HeaderText="Supplier" DataField="SupplierNamee">
                            <HeaderStyle HorizontalAlign="center" Width="7%" />
                        </asp:BoundColumn>
                        <asp:BoundColumn ItemStyle-HorizontalAlign="center" HeaderStyle-BackColor="#04A4BD" HeaderStyle-ForeColor ="Black" HeaderText="Delivery Date" DataField="DeliveryDatee">
                            <HeaderStyle HorizontalAlign="center" Width="5%" />
                        </asp:BoundColumn>
                        <asp:BoundColumn ItemStyle-HorizontalAlign="center" HeaderStyle-BackColor="#04A4BD" HeaderStyle-ForeColor ="Black" HeaderText="Quantity" DataField="POQTY">
                            <HeaderStyle HorizontalAlign="center" Width="5%" />
                        </asp:BoundColumn>
                        <asp:BoundColumn ItemStyle-HorizontalAlign="center" HeaderStyle-BackColor="#04A4BD" HeaderStyle-ForeColor ="Black" HeaderText="Inditex PO No" DataField="InditexPONo">
                            <HeaderStyle HorizontalAlign="center" Width="5%" />
                        </asp:BoundColumn>
                        ...
                        <asp:BoundColumn ItemStyle-HorizontalAlign="center" Visible="false" HeaderText="ClosedStatus"
                            DataField="ClosedStatus">
                            <HeaderStyle HorizontalAlign="center" Width="5%" />
                        </asp:BoundColumn>
                         <asp:TemplateColumn HeaderText="Auditor Closed" Visible="true" HeaderStyle-BackColor="#04A4BD" HeaderStyle-ForeColor ="Black">
                            <ItemTemplate>
                                <asp:CheckBox ID="ChkAuditorClosedStatus" OnCheckedChanged="AuditorStatus" AutoPostBack="true"
                                    runat="server" />
                            </ItemTemplate>
                            <HeaderStyle Width="2%" />
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateColumn>
                          <asp:BoundColumn ItemStyle-HorizontalAlign="center" HeaderText="FabricPOrder" DataField="FabricPOrder"
                            Visible="false">
                            <HeaderStyle HorizontalAlign="center" Width="5%" />
                        </asp:BoundColumn>
                    </Columns>
              ...
              <div style="width: 920PX; overflow: scroll; HEIGHT: 350PX;" >
                <Smart:SmartDataGrid ID="DgAuthorised" runat="server" Width="100%" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn ItemStyle-HorizontalAlign="center" HeaderStyle-BackColor="#04A4BD" HeaderStyle-ForeColor ="Black" HeaderText="FabricStatus" DataField="FabricStatus"
                            Visible="false">
                            <HeaderStyle HorizontalAlign="center" Width="5%" />
                        </asp:BoundColumn>
                        <asp:BoundColumn ItemStyle-HorizontalAlign="center" HeaderText="POTypeID" DataField="POTypeID"
