<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WIPtemprory.aspx.vb" Inherits="Integra.WIPtemprory" %>
				         	...
				         	<ASP:BOUNDCOLUMN HeaderText="Style No."
								...
								<ASP:BOUNDCOLUMN HeaderText="Color"
								 ...
								 <headerstyle width="10%" horizontalalign="Left"  />
									...
									<ITEMTEMPLATE>
                                    <asp:LinkButton id="lnkWIPremarks" CommandName="WIPRemarks" runat="server">Comments</asp:LinkButton>
                                    </ITEMTEMPLATE>
