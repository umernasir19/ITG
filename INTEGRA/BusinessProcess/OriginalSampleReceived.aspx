<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="OriginalSampleReceived.aspx.vb" Inherits="Integra.OriginalSampleReceived" %>
    ...
    <table width="100%">
        <tr style="border-bottom-style: solid; border-bottom-color: #00509F; border-bottom-width: thin;"
            ...
            <th colspan="6" align="left" style="font-family: Arial; font-size: 16PX; font-weight: bold;
                color: #808080;">
                Original Sample Received From Buyer
            </th>
        </tr>
    </table>
    <table width="100%">
                                    ...
                                    <asp:TemplateColumn HeaderText="Sample Type">
                                        ...
                                        <ItemTemplate>
                                            <asp:DropDownList ID="cmbSampleType" CssClass="dd" Width="100" runat="server">
                                                <asp:ListItem>Original Sample</asp:ListItem>
