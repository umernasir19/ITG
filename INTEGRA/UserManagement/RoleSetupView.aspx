<%@ Page Title="Role Setup View" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="RoleSetupView.aspx.vb" Inherits="Integra.RoleSetupView" %>
                ...
                <div style="width :920PX; overflow :scroll ;">
                    <telerik:RadGrid ID="dgRoleSetupView" runat="server" CellSpacing="0" AutoGenerateColumns="False"
                        ...
                        <MasterTableView AutoGenerateColumns="false" AllowFilteringByColumn="True" ShowFooter="True"
                            ...
                            <Columns>
                                <telerik:GridBoundColumn HeaderText="RoleId" DataField="RoleId" Display="false">
                                ...
                                <telerik:GridTemplateColumn HeaderText="View" UniqueName="View" AllowFiltering="false"
                                    Display="true">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="lnkEdit" Font-Underline="false" Text="Update" Enabled="true" NavigateUrl='<%# "RoleSetup.aspx?RoleID=" &amp; DataBinder.Eval(Container.DataItem,"RoleID")%>'
