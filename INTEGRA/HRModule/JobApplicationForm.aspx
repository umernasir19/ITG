<%@ Page Language="vb" MasterPageFile="~/MasterPage.master"  AutoEventWireup="false" CodeBehind="JobApplicationForm.aspx.vb" Inherits="Integra.JobApplicationForm" %>
 ...
 <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <td><table border="0" cellpadding="0" cellspacing="0">
        ...
        <tr style="border-bottom-style: solid; border-bottom-color: #00509F; border-bottom-width: thin;" 
              visible="true";> 
                   <th colspan ="6" align="left"   style="font-family:Calibri; font-size: 18PX; font-weight: bold; color: #808080; width:600px;">Personal Profile</th>
                               
                    </tr>
                         <tr style="width:128px; height: 5px; "></tr>
             <tr>
             
      <td style="width:128px; height: 25px; font-family:Calibri; font-size:14px; color:Black; ">
            ...
            <tr>
            <td style="width: 128px; height: 30px; font-family:Calibri; font-size:14px; color:Black;">
            ...
            <td style="width: 128px; height: 30px; font-family:Calibri; font-size:14px; color:Black;">   <asp:FileUpload ID="imgEmployee" runat="server"   /></td>
                <td style="height: 30px; width: 85px;"> </td>
                    <td style="height: 30px; width: 70px;"> </td>
                        <td style="height: 30px; width: 55px;"> </td>
    ...
    <div class="image"> <table><tr><td>    <asp:Image ID="Image2" runat="server"   Width="100" /></td></tr></table></div>
     ...
     <table border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td style="height: 30px; width: 128px; font-family:Calibri; font-size:14px; color:Black;">
...
<DatePopupButton ImageUrl="" HoverImageUrl="" TabIndex="2"></DatePopupButton>
            ...
            <td style="height: 30px; width: 85px; font-family:Calibri; font-size:14px; color:Black;">
         ...
         <tr>
           ...
           <telerik:RadTextBox ID="txtCity" Runat="server" Skin="WebBlue" 
            ...
            <td class="style4 " style="font-family:Calibri; font-size:14px; color:Black;">
           ...
           <telerik:RadTextBox ID="txtResidenceAddressB" Runat="server" Skin="WebBlue"   
            ...
            <td class="TopHeaderTd3" style="width: 166px; height: 30px;">
            ...
            <tr>
            <td style="height: 30px; width: 128px; font-family:Calibri; font-size:14px; color:Black;">
                <asp:Label ID="lblEmergencyContactNo" runat="server" Text="Emergency Con No"></asp:Label>
            </td>
              <td class="TopHeaderTd3" style="width: 165px; height: 30px;"> 
           ...
           <tr  style="border-bottom-style: solid; border-bottom-color: #00509F; border-bottom-width: thin; z-index: auto;" 
              visible="true";>
       <th colspan ="5" align="left" style="font-family:Calibri; font-size: 18PX; font-weight: bold; color: #808080;" >Education & Skills</th>
       </tr>
            <tr style="width:128px; height: 5px; "></tr>
           <tr>
            <td class="style4" style="font-family:Calibri; font-size:14px; color:Black;">
     ...
     <%--'-------Heading Row--------'--%>
        <tr  style="border-bottom-style: solid; border-bottom-color: #00509F; border-bottom-width: thin; z-index: auto;" 
              visible="true";>
        <th colspan ="5" align="left" style="font-family:Calibri; font-size: 18PX; font-weight: bold; color: #808080;" >
        Last Job Particulars (if any)</th>
          ...
          <tr>
            <td class="style4" style="font-family:Calibri; font-size:14px; color:Black;">
                <asp:Label ID="Label11" runat="server" Text="/ Month Sal(In Digits):" ToolTip="Per Month Salary"></asp:Label>
            </td>
            <td  class="TopHeaderTd3" style="width: 166px; height: 30px;">
