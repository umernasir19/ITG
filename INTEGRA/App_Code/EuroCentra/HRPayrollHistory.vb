...
Namespace EuroCentra
    Public Class HRPayrollHistory

        Inherits SQLManager
        Public Sub New()
            m_strTableName = "HRPayrollHistory"
            m_strPrimaryFieldName = "HistoryID"
            m_enPrimaryFieldDataType = SQLManager.DataTypes.LongType
        End Sub
        ''''''''''''''''''''''''''''''''''''''''''''''
        Private m_lHistoryID As Long
        Private m_lHRID As Long
        Private m_dtHistoryDate As Date
        ...
        Public Property HistoryDate() As Date
            Get
                HistoryDate = m_dtHistoryDate
            End Get
            Set(ByVal value As Date)
                m_dtHistoryDate = value
            End Set
        End Property
        ...
        Public Property MiscAllowance() As Decimal
            ...
            End Set
        End Property
        Public Function SaveHRPayrollHistory()
            Try
                MyBase.Save()
