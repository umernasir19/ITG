...
Namespace EuroCentra
    Public Class StyleProductInformation
        Inherits SQLManager
        Public Sub New()
            m_strTableName = "StyleProductInformation"
            m_strPrimaryFieldName = "SproductID"
            m_enPrimaryFieldDataType = SQLManager.DataTypes.LongType
        End Sub
        Private m_SproductID As Long
        ...
        Public Property SproductID() As Long
            Get
                SproductID = m_SproductID
            End Get
            Set(ByVal value As Long)
                m_SproductID = value
            End Set
        ...
        Public Function GetID()
            ...
            End Try
        End Function
        Public Function DeleteDetail(ByVal SproductID As Long)
            Dim Str As String
            Str = " delete from StyleProductInformation where  SproductID='" & SproductID & "'"
            Try
