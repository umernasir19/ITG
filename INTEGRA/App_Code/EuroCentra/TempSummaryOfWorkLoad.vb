...
Namespace EuroCentra
    Public Class TempSummaryOfWorkLoad
        Inherits SQLManager
        Public Sub New()
            m_strTableName = "TempSummaryOfWorkLoad"
        ...
        Public Function TruncateTable()
            Dim str As String = "TRUNCATE TABLE  TempSummaryOfWorkLoad"
            Try
                MyBase.ExecuteNonQuery(str)
            Catch ex As Exception
            End Try
        End Function
        Public Function GetVender(ByVal startdate As String, ByVal Enddate As String, ByVal SEASON As String, ByVal Customerid As String, ByVal BuyingDept As String, ByVal supplieridd As String) As DataTable
            Dim Str As String
            ...
            If supplieridd <> 0 Then
                If SEASON = "All" And BuyingDept = "All" Then
                    ...
                    Str &= " where po.ShipmentDate between '" & startdate & "' and '" & Enddate & "' AND po.customerid='" & Customerid & "' and PO.Supplierid='" & supplieridd & "' order by VenderName"
                ...
                ElseIf SEASON = "All" And BuyingDept <> "All" Then
                    ...
                    Str &= "  eknumber='" & BuyingDept & "' and PO.Supplierid='" & supplieridd & "' order by VenderName"
                ElseIf SEASON <> "ALL" And BuyingDept = "All" Then
                    Str = " SELECT distinct  VenderName,PO.Supplierid "
                    Str &= " FROM PURCHASEORDER po"
                    Str &= " JOIN PurchaseOrderDetail POD ON PO.POID=POD.POID"
                    ...
                    Str &= " Join StyleMaster SM ON SM.STYLEID=POD.STYLEID"
                    Str &= " where po.ShipmentDate between '" & startdate & "' and '" & Enddate & "' AND po.customerid='" & Customerid & "' and "
                    Str &= " Season='" & SEASON & "' and PO.Supplierid='" & supplieridd & "' order by VenderName"
                Else
                    Str = " SELECT distinct  VenderName,PO.Supplierid "
                    Str &= " FROM PURCHASEORDER po"
                    Str &= " JOIN PurchaseOrderDetail POD ON PO.POID=POD.POID"
                    ...
                    Str &= " Join StyleMaster SM ON SM.STYLEID=POD.STYLEID"
                    Str &= " where po.ShipmentDate between '" & startdate & "' and '" & Enddate & "' AND po.customerid='" & Customerid & "' and "
                    Str &= " Season='" & SEASON & "'  and eknumber='" & BuyingDept & "' and PO.Supplierid='" & supplieridd & "' order by VenderName"
                End If
            Else
                If SEASON = "All" And BuyingDept = "All" Then
                    Str = " SELECT distinct  VenderName,PO.Supplierid "
                    ...
                    Str &= " join Vender V on V.VenderLibraryID=PO.Supplierid"
                    Str &= " Join StyleMaster SM ON SM.STYLEID=POD.STYLEID"
                    Str &= " where po.ShipmentDate between '" & startdate & "' and '" & Enddate & "' AND po.customerid='" & Customerid & "' order by VenderName"
                ...
                ElseIf SEASON = "All" And BuyingDept <> "All" Then
                    ...
                    Str &= " Join StyleMaster SM ON SM.STYLEID=POD.STYLEID"
                    Str &= " where po.ShipmentDate between '" & startdate & "' and '" & Enddate & "' AND po.customerid='" & Customerid & "' and "
                    Str &= "  eknumber='" & BuyingDept & "' order by VenderName"
                ElseIf SEASON <> "ALL" And BuyingDept = "All" Then
                    Str = " SELECT distinct  VenderName,PO.Supplierid "
                    Str &= " FROM PURCHASEORDER po"
                    Str &= " JOIN PurchaseOrderDetail POD ON PO.POID=POD.POID"
                    ...
                    Str &= " Join StyleMaster SM ON SM.STYLEID=POD.STYLEID"
                    Str &= " where po.ShipmentDate between '" & startdate & "' and '" & Enddate & "' AND po.customerid='" & Customerid & "' and "
                    Str &= " Season='" & SEASON & "' order by VenderName"
                Else
                    Str = " SELECT distinct  VenderName,PO.Supplierid "
                    Str &= " FROM PURCHASEORDER po"
                    Str &= " JOIN PurchaseOrderDetail POD ON PO.POID=POD.POID"
                    ...
                    Str &= " Join StyleMaster SM ON SM.STYLEID=POD.STYLEID"
                    Str &= " where po.ShipmentDate between '" & startdate & "' and '" & Enddate & "' AND po.customerid='" & Customerid & "' and "
                    Str &= " Season='" & SEASON & "'  and eknumber='" & BuyingDept & "' order by VenderName"
                End If
            End If
            ...
            End Try
        End Function
        Public Function getdataforWorkLoadSummary(ByVal startdate As String, ByVal Enddate As String, ByVal SEASON As String, ByVal Customerid As String, ByVal BuyingDept As String, ByVal Supplierid As String) As DataTable
            Dim Str As String
            ...
            If SEASON = "All" And BuyingDept = "All" Then
                Str = "  SELECT isnull(count(distinct PO.Masterpo),0) as Nooforder,isnull(count(distinct SM.STYLEno),0) as Nooflines,"
            ...
            ElseIf SEASON = "All" And BuyingDept <> "All" Then
                ...
                Str &= " Join StyleMaster SM ON SM.STYLEID=POD.STYLEID"
                Str &= " where po.ShipmentDate between '" & startdate & "' and '" & Enddate & "' AND po.customerid='" & Customerid & "' and "
                Str &= "  PO.Supplierid='" & Supplierid & "' and eknumber='" & BuyingDept & "'"
            ElseIf SEASON <> "ALL" And BuyingDept = "All" Then
                Str = "  SELECT isnull(count(distinct PO.Masterpo),0) as Nooforder,isnull(count(distinct SM.STYLEno),0) as Nooflines,"
                Str &= " isnull(sum(POD.Quantity*SM.QtyPack),0) as OrderQtyInPcs ,isnull(sum(POD.Quantity),0) as OrderQty"
                Str &= " FROM PURCHASEORDER po"
                ...
                Str &= " Join StyleMaster SM ON SM.STYLEID=POD.STYLEID"
                Str &= " where po.ShipmentDate between '" & startdate & "' and '" & Enddate & "' AND po.customerid='" & Customerid & "' and "
                Str &= " Season='" & SEASON & "' and  PO.Supplierid='" & Supplierid & "'  "
            Else
                Str = "  SELECT isnull(count(distinct PO.Masterpo),0) as Nooforder,isnull(count(distinct SM.STYLEno),0) as Nooflines,"
                Str &= " isnull(sum(POD.Quantity*SM.QtyPack),0) as OrderQtyInPcs ,isnull(sum(POD.Quantity),0) as OrderQty"
                Str &= " FROM PURCHASEORDER po"
            ...
            End Try
        End Function
        Public Function getdataforWorkLoadSummaryForMonth1(ByVal Month1 As String, ByVal Year As String, ByVal SEASON As String, ByVal Customerid As String, ByVal BuyingDept As String, ByVal Supplierid As String) As DataTable
            Dim Str As String
            'Str = "  SELECT POD.POID,POD.STYLEID,POD.Quantity*SM.QtyPack as OrderQtyInPcs ,POD.Quantity as OrderQty"
            'Str &= " FROM PURCHASEORDER po"
            'Str &= " JOIN PurchaseOrderDetail POD ON PO.POID=POD.POID"
            ...
            If SEASON = "All" And BuyingDept = "All" Then
                ...
                Str &= " JOIN PurchaseOrderDetail POD ON PO.POID=POD.POID"
                Str &= " Join StyleMaster SM ON SM.STYLEID=POD.STYLEID"
                Str &= " where  Month(po.ShipmentDate) ='" & Month1 & "' and Year(po.ShipmentDate)='" & Year & "' AND po.customerid='" & Customerid & "' and "
                Str &= "    PO.Supplierid='" & Supplierid & "'  "
            ElseIf SEASON = "All" And BuyingDept <> "All" Then
                Str = "  SELECT isnull(count(distinct PO.Masterpo),0) as Nooforder,isnull(count(distinct POD.STYLEID),0) as Nooflines,"
                Str &= " isnull(sum(POD.Quantity*SM.QtyPack),0) as OrderQtyInPcsM1 ,isnull(sum(POD.Quantity),0) as OrderQtyM1"
            ...
            End Try
        End Function
        Public Function getdataforWorkLoadSummaryForMonth2(ByVal Month2 As String, ByVal Year As String, ByVal SEASON As String, ByVal Customerid As String, ByVal BuyingDept As String, ByVal Supplierid As String) As DataTable
            Dim Str As String
            'Str = "  SELECT POD.POID,POD.STYLEID,POD.Quantity*SM.QtyPack as OrderQtyInPcs ,POD.Quantity as OrderQty"
            'Str &= " FROM PURCHASEORDER po"
            'Str &= " JOIN PurchaseOrderDetail POD ON PO.POID=POD.POID"
            ...
            If SEASON = "All" And BuyingDept = "All" Then
                ...
                Str &= " JOIN PurchaseOrderDetail POD ON PO.POID=POD.POID"
                Str &= " Join StyleMaster SM ON SM.STYLEID=POD.STYLEID"
                Str &= " where  Month(po.ShipmentDate) ='" & Month2 & "' and Year(po.ShipmentDate)='" & Year & "' AND po.customerid='" & Customerid & "' and "
                Str &= "    PO.Supplierid='" & Supplierid & "'  "
            ElseIf SEASON = "All" And BuyingDept <> "All" Then
                Str = "  SELECT isnull(count(distinct PO.Masterpo),0) as Nooforder,isnull(count(distinct POD.STYLEID),0) as Nooflines,"
                Str &= " isnull(sum(POD.Quantity*SM.QtyPack),0) as OrderQtyInPcsM2 ,isnull(sum(POD.Quantity),0) as OrderQtyM2"
            ...
            End Try
        End Function
        Public Function getdataforWorkLoadSummarySHIPPEDMonth1(ByVal Month1 As String, ByVal Year As String, ByVal SEASON As String, ByVal Customerid As String, ByVal BuyingDept As String, ByVal Supplierid As String) As DataTable
            Dim Str As String
            If SEASON = "All" And BuyingDept = "All" Then
            ...
            ElseIf SEASON = "All" And BuyingDept <> "All" Then
                ...
                Str &= " Join StyleMaster SM ON SM.STYLEID=POD.STYLEID"
                Str &= " where  month(po.ShipmentDate)= '" & Month1 & "' and Year(po.ShipmentDate)='" & Year & "' AND po.customerid='" & Customerid & "' and "
                Str &= "   eknumber='" & BuyingDept & "'and  PO.Supplierid='" & Supplierid & "'"
            ElseIf SEASON <> "ALL" And BuyingDept = "All" Then
                Str = " select isnull(sum(cd.Quantity*SM.QtyPack),0) as ShippedOrderQtyInPcsM1 ,isnull(sum(cd.Quantity),0) as ShippedOrderQtyM1 from Cargo cr "
                Str &= " join CargoDetail cd on cr.cargoid=cd.cargoid"
                Str &= "  join PurchaseOrder po on po.POID=cd.POPOID"
            ...
            End Try
        End Function
        Public Function getdataforWorkLoadSummarySHIPPEDMonth2(ByVal Month2 As String, ByVal Year As String, ByVal SEASON As String, ByVal Customerid As String, ByVal BuyingDept As String, ByVal Supplierid As String) As DataTable
            Dim Str As String
            If SEASON = "All" And BuyingDept = "All" Then
            ...
            End Try
        End Function
        Public Function getdataforWorkLoadSummarySHIPPED(ByVal startdate As String, ByVal Enddate As String, ByVal SEASON As String, ByVal Customerid As String, ByVal BuyingDept As String, ByVal Supplierid As String) As DataTable
            Dim Str As String
            If SEASON = "All" And BuyingDept = "All" Then
                Str = " select isnull(sum(cd.Quantity*SM.QtyPack),0) as ShippedOrderQtyInPcs ,isnull(sum(cd.Quantity),0) as ShippedOrderQty from Cargo cr "
                Str &= " join CargoDetail cd on cr.cargoid=cd.cargoid"
