...
Namespace EuroCentra
    Public Class SamplingHistory
        Inherits SQLManager
        Public Sub New()
            m_strTableName = "SamplingHistory"
            m_strPrimaryFieldName = "SamplingHistoryID"
            m_enPrimaryFieldDataType = SQLManager.DataTypes.LongType
        End Sub
        Private m_lSamplingHistoryID As Long
        ...
        Public Property SamplingHistoryID() As Long
            Get
                SamplingHistoryID = m_lSamplingHistoryID
            End Get
            Set(ByVal value As Long)
                m_lSamplingHistoryID = value
            End Set
        End Property
        ...
        Public Property NoofPcsRecvd() As Decimal
            ...
            End Set
        End Property
        Public Function SaveSamplingHistory()
            Try
                MyBase.Save()
