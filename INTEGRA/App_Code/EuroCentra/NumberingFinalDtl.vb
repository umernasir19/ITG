...
Imports System.Data
Public Class NumberingFinalDtl
    Inherits SQLManager
    Public Sub New()
        m_strTableName = "NumberingFinalDtl"
        m_strPrimaryFieldName = "NumberingFinalDtlID"
    ...
    Private m_strSelectPacking As String
    Private m_strDonePacking As String
    Public Property DonePacking() As String
        Get
            DonePacking = m_strDonePacking
        End Get
        Set(ByVal value As String)
            m_strDonePacking = value
        End Set
    End Property
    Public Property SelectPacking() As String
        Get
            SelectPacking = m_strSelectPacking
        End Get
        Set(ByVal value As String)
            m_strSelectPacking = value
        End Set
    End Property
