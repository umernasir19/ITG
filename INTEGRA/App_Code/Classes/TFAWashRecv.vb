...
Imports System.Data
Public Class TFAWashRecv
    Inherits SQLManager
    Public Sub New()
        m_strTableName = "TFAWashingRecv"
        m_strPrimaryFieldName = "TFAWashingRecvid"
        m_enPrimaryFieldDataType = SQLManager.DataTypes.LongType
    End Sub
    Private m_lTFAWashingRecvid As Long
    ...
    Private m_dWashingRecvBit As Decimal
    ...
    Public Property CreationDate() As Date
        ...
        End Set
    End Property
    Public Property TFAWashingRecvid() As Long
        Get
            TFAWashingRecvid = m_lTFAWashingRecvid
        End Get
        Set(ByVal Value As Long)
            m_lTFAWashingRecvid = Value
        End Set
    End Property
    ...
    Public Property TotalSizeQty() As Decimal
        ...
        End Set
    End Property
    Public Property WashingRecvBit() As Decimal
        Get
            WashingRecvBit = m_dWashingRecvBit
        End Get
        Set(ByVal value As Decimal)
            m_dWashingRecvBit = value
        End Set
    End Property
