...
Public Class ReceiveWashingManual
            ...
            Else
                ...
                Else
                    ...
                    If LalblStyle.Text = "" Then
                        lblmsg.Text = ""
                        objAutoComplete.GetValueWR(txtBarcode.Text, lblmsg, dgRecvWash, txtBarcode)
                    Else
                        lblmsg.Text = ""
                        objAutoComplete.GetValueWR(txtBarcode.Text, lblmsg, dgRecvWash, txtBarcode)
                    End If
                    ...
                    For Each row In dgRecvWash.Rows
                        ...
                        With objTFAWashRecv
                            ...
                            .Code = dgRecvWash.Rows(y).Cells(1).Text
                            .Merchandiser = dgRecvWash.Rows(y).Cells(2).Text
                            .JobNo = dgRecvWash.Rows(y).Cells(3).Text
                            .TotalOrderQty = dgRecvWash.Rows(y).Cells(4).Text
                            .Style = dgRecvWash.Rows(y).Cells(5).Text
                            .Item = dgRecvWash.Rows(y).Cells(6).Text
                            .Brand = dgRecvWash.Rows(y).Cells(7).Text
                            .Sizes = dgRecvWash.Rows(y).Cells(9).Text
                            .TotalSizeQty = dgRecvWash.Rows(y).Cells(8).Text
                            .WashingRecvBit = 1
