<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FinishingManual.aspx.vb" Inherits="Integra.FinishingManual" %>
     ...
     <div style="margin: 0 auto; text-align: center; width: 714px; margin-top: -38px;">
        ...
        <table>
                <tr>
                  ...
                  <asp:GridView ID="DgFinishing" runat="server" Width="100%"  AutoGenerateColumns="False" EmptyDataText="There are no data records to display."
                BorderStyle="Solid">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Total Washing Receive Qty" DataField="TotalWashingBit">
                                    <HeaderStyle HorizontalAlign="Center" Width="10%" />
                                    <ItemStyle HorizontalAlign="Center"   />
                                </asp:BoundField>
