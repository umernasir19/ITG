<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DeversaLogin.aspx.vb" Inherits="Integra.DeversaLogin" %>
...
<head id="Head1" runat="server">
  <link href="css/V3screen.css" rel="stylesheet" type="text/css" media="screen" />
    <title>Euro Centra B2B-INTEGRA ERP- Login Page</title>
...
<body  id="newLoginPage" onload="MM_preloadImages('images/button-tabs/btn_h.png')">
   <form id="dd" runat="server">
    ...
    <img src="images/layout/Deversa.png" alt="SoftLayer(R)" id="login-logo" />
  <div id="content-container">
    <div id="content-box">
        <div id="login-box-header">
            <p id="content-box-title">Login</p>
        </div>

        <div id="login-box">
        <div class="message"><asp:Label ID="lblErrorMsg" runat="server" Text=""></asp:Label></div>
            <form method="post" id="loginform" name="loginform">



                <div class="login-box-row">
                    <label for="user_username" class="login-box-label">Username</label>
                ...
                <div class="login-box-row">
                    <label for="user_password" class="login-box-label">Password</label>
             ...
             <telerik:RadButton ID="btnLogin" runat="server" Text="LOG IN" Skin="WebBlue"></telerik:RadButton>
              </div>
...
<div class="txxxt"><span>Powered by :</span></div>
<div class="txxxt_2"><a href="http://itg.net.pk/" target="_blank"><img src="images/layout/footer_img.png" alt="" /></a></div>
</div>
