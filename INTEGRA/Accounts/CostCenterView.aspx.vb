...
Public Class CostCenterView
    ...
    Function LoadData() As ICollection
        ...
        objDataTable = ObjCostCenter.View()
    ...
    Protected Sub dgView_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles dgView.ItemCommand
        Try
            Select Case e.CommandName
                Case "Edit"
                    Dim CostCenterID As String = dgView.Items(e.Item.ItemIndex).Cells(0).Text
                    DirectCast(Me.Page.Master, MasterPage).ShowMessgae("  ")
                    Response.Redirect("CostingCenter.aspx?CostCenterID=" & CostCenterID & "")
    ...
    Protected Sub btndAdd_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btndAdd.Click
        Response.Redirect("CostingCenter.aspx")
    End Sub
End Class
