...
Public Class SupplierLedgerReport
    ...
    Protected Sub btnReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReport.Click
        ...
        Else
            ...
            Next
            Dim FileName As String = "Supplier Ledger"
            'PartiesLedger()
            ' Report.Load(Server.MapPath("~/Reports/SupplierLedgerNew.rpt"))
            'Report.Load(Server.MapPath("~/Reports/PartiesLedger.rpt"))
            Report.Load(Server.MapPath("~/Reports/PartiesLedgerForNM.rpt"))
            Report.Refresh()
    ...
    Sub GetDateForLedgerReport()
        ...
        objSupplierledger.TruncateTempLedgerTableNew()
        ...
        objSupplierledger.InsertSupplierLedgerDataWithOUtDateNew(txtAccountCode.Text, cmbSupplier.SelectedValue)
        objSupplierledger.TruncateTempLedgerFinalTableNew()
        ' objSupplierledger.InsertSupplierLedgerFinalData(sdatee, edate)
        objSupplierledger.InsertSupplierLedgerFinalDataWithOutDateNew()
