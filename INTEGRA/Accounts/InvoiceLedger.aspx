<%@ Page Title="Invoice Ledger" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="InvoiceLedger.aspx.vb" Inherits="Integra.InvoiceLedger" %>
...
<table width="100%">
        <tr>
            ...
            <td>
                <div class="text_box" style="">
                    <asp:DropDownList ID="cmbSupplier" Width="150" Style="margin-left: 0px;" CssClass="combo"
                        AutoPostBack="true" Visible ="false"  runat="server">
                    </asp:DropDownList>
                         <asp:TextBox ID="txtSupplierSearch" Style="margin-left: 0px;"
                        runat="server" AutoPostBack="true" Font-Size="8pt"></asp:TextBox>
        ...
        <tr>
            <td style="width: 150px;">
                <div class="txt_newwww" style="width: 140px; margin-top: 3px;">
                    Start Date
                </div>
            </td>
            <td>
