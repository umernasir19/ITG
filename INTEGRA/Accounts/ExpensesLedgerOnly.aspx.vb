...
Public Class ExpensesLedgerOnly
    ...
    Protected Sub btnReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReport.Click
        ...
        Else
            ...
            Next
            Dim FileName As String = "Expense Ledger"
            Report.Load(Server.MapPath("~/Reports/ExpenseLedger.rpt"))
            Report.Refresh()
    ...
    Sub GetDateForLedgerReport()
        ...
        objSupplierledger.TruncateTempLedgerEXPTableOnly()
        objSupplierledger.InsertSupplierLedgerDataForExpensesLedgerOnly(txtAccountCode.Text, cmbSupplier.SelectedValue)
        objSupplierledger.TruncateTempLedgerFinalexpTableOnly()
        objSupplierledger.InsertSupplierLedgerFinalDataExpensesOnly()
