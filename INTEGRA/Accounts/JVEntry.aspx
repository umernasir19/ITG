<%@ Page Title="JV Entry" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master"
    CodeBehind="JVEntry.aspx.vb" Inherits="Integra.JVEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <tr style="height: 35px;">
            ...
            <td>
                <asp:TextBox ID="txtVoucherdate2" CssClass="textbox" Width="75" runat="server" Visible="False"
                    AutoPostBack="False" Style="text-transform: uppercase;" ToolTip="dd/mm/yyyy" placeholder="dd/mm/yyyy"
                    autocomplete="off"></asp:TextBox>
                <asp:TextBox ID="txtVoucherdate" CssClass="textbox" Width="120" runat="server" AutoPostBack="false"
            ...
            <td>
                <asp:CheckBox runat="server" ID="chkshowCalander" Visible="false" AutoPostBack="False" />
            </td>
        </tr>
        <tr style="height: 35px;">
            <td style="width: 100px;">
    ...
    <table width="100%">
        ...
        <tr style="height: 35px;">
            ...
            <td>
                <asp:Button ID="btnAdd" Text="Add NEW ROW" TabIndex="3" runat="server" Width="100"
