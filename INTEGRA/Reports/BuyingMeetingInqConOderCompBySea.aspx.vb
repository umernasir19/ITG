...
Public Class BuyingMeetingInqConOderCompBySea
    ...
    Sub bindSeason()
        ...
        dtSeason = ObjCustomer.GetSeasonReport
    ...
    Protected Sub btnViewReport_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnViewReport.Click
        Try
            ...
            Report.Load(Server.MapPath("..\Reports/BuyingMeetingEnquiriesReceivedCompBySeason.rpt"))
            Report.Refresh()
            Dim di As DirectoryInfo = New DirectoryInfo(Server.MapPath("~/TempPDF"))
            di.Create()
            Dim FileName As String = "Buying Meeting Inq&Order Confirm"
            ...
            Report.SetParameterValue(3, txtStartDatee.SelectedDate)
            Report.SetParameterValue(4, txtEndDatee.SelectedDate)
            Report.SetParameterValue(5, cmbSeason.SelectedValue)
            Report.SetParameterValue(6, CustomerName)
