<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master"
    CodeBehind="BuyingMeetingConOrderStylingDetail.aspx.vb" Inherits="Integra.BuyingMeetingConOrderStylingDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="100%">
        ...
        <tr style="border-bottom-style: solid; border-bottom-color: #00509F; border-bottom-width: thin;"
            ...
            <th colspan="5" align="left" style="font-family: Arial; font-size: 16PX; font-weight: bold;
                color: #808080;">
              Buying Meeting Confirmed Order and Styling Details List
            </th>
        </tr>
    </table>
    <br />
    <table>
        ...
        <tr style="height: 35px;">
            ...
            <td>
                <asp:DropDownList ID="cmbBuyerName"  AutoPostBack="true"  runat="server" Style="width: 140px; margin-left: 75px;">
                </asp:DropDownList>
            </td>
        </tr>
            <tr style="height: 35px;">
