...
Public Class InquiriesRecBuyerReqChecklist
    ...
    Sub downloadReport()
        ...
        Report.Load(Server.MapPath("..\Reports/EnquiryRecvBuyerRequirement.rpt"))
        Report.Refresh()
        Dim di As DirectoryInfo = New DirectoryInfo(Server.MapPath("~/TempPDF"))
        di.Create()
        Dim FileName As String = "InquiriesRecBuyerReqChecklist"
        ...
        Report.SetParameterValue(6, txtMeetingDate.SelectedDate)
