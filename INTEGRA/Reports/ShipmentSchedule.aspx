<%@ Page Title="Shipment Schedule" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="ShipmentSchedule.aspx.vb" Inherits="Integra.ShipmentSchedule" %>
...
<script type="text/javascript">
   ...
   <table>
        <tr>
            ...
            <td valign="top">
                <telerik:RadDatePicker ID="txtDateFrom" runat="server" Culture="en-US" style="margin-left: 72px;">
            ...
            <td>
                <asp:Label ID="lblTo" runat="server" style="    margin-left: 0px;" Text="To :"></asp:Label>
            </td>
            <td valign="top">
                <telerik:RadDatePicker ID="txtDateTo" runat="server" style="   margin-left: 0px;" Culture="en-US">
