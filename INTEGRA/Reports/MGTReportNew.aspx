<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master"
    CodeBehind="MGTReportNew.aspx.vb" Inherits="Integra.MGTReportNew" %>
                    ...
                    <ContentTemplate>
                        <telerik:RadComboBox ID="cmbreporttype" runat="server" AutoPostBack="True" Skin="WebBlue">
                            <Items>
                               ...
                               <%-- <telerik:RadComboBoxItem Value="5" Text="Buying Department Analysis" />
                                <telerik:RadComboBoxItem Value="6" Text="Article Vise" />--%>
                            </Items>
                        </telerik:RadComboBox>
                    </ContentTemplate>
                </asp:UpdatePanel>
