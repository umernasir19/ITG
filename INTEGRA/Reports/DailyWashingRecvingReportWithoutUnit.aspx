<%@ Page Title="Daily Washing Receiving Report" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="DailyWashingRecvingReportWithoutUnit.aspx.vb" Inherits="Integra.DailyWashingRecvingReportWithoutUnit" %>
    ...
    <table>
        <tr>
            <th colspan="6" align="left" style="font-family: 'Times New Roman', Times, serif;
                ...
                bgcolor="Silver">
                Daily Washing Receiving Report
            </th>
        </tr>
