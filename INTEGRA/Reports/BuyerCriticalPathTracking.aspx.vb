...
Public Class BuyerCriticalPathTracking
    ...
    Protected Sub btnView_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnView.Click
        ...
        Else
            ...
            'Report.Load(Server.MapPath("..\Reports/CustomerActionENQNew.rpt"))
            Report.Load(Server.MapPath("..\Reports/BuyingMeetingConOderCkhList.rpt"))
            ...
            di.Create()
            Dim FileName As String = "Buyer Critical Path"
