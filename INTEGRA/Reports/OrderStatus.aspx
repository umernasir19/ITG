<%@ Page Title="ORDER STATUS REPORT" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master"
    CodeBehind="OrderStatus.aspx.vb" Inherits="Integra.OrderStatus" %>
     ...
     <table>
      <tr>
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="lblTo" runat="server" style="    margin-left: -93px;" Text="To :"></asp:Label>
            </td>
            <td valign="top">
                <telerik:RadDatePicker ID="txtDateTo" runat="server" style="   margin-left: -165px;" Culture="en-US">
