<%@ Page Title="Item Invetory Report" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master"
    CodeBehind="ItemInvetoryReportForFStore.aspx.vb" Inherits="Integra.ItemInvetoryReportForFStore" %>
        ...
        <tr style="height: 34px;">
            ...
            <td class="TopHeaderTable3" style="width: 166px; height: 30px;">
                ...
                <cc1:AutoCompleteExtender ID="AutoCompleteExtender9" runat="server" CompletionInterval="10"
                    CompletionSetCount="12" ContextKey="ItemCategoryForItemInventoryReport" EnableCaching="true" MinimumPrefixLength="1"
                    ServiceMethod="GetCompletionList" ServicePath="~/AutoComplete.asmx" TargetControlID="txtFabricCode" />
