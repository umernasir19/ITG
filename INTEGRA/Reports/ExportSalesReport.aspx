<%@ Page Title="Export Sales Report" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="ExportSalesReport.aspx.vb" Inherits="Integra.ExportSalesReport" %>
     ...
     <table>
      <tr>
         ...
         <td style="width: 110px;">
            ...
            <td class="TopHeaderTable3" style="width: 166px; height: 30px;">
                <telerik:RadComboBox ID="cmbInvoiceno" runat="server" AutoPostBack="false" Skin="WebBlue">
                </telerik:RadComboBox>
            </td>
         ...
         <td style="width: 110px;">
            ...
            <td class="TopHeaderTable3" style="width: 166px; height: 30px;">
                <telerik:RadComboBox ID="cmbSno" runat="server" AutoPostBack="false" Skin="WebBlue">
                </telerik:RadComboBox>
            </td>
            </tr> 
        <tr>
