<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="GoodRecvNote.aspx.vb" Inherits="Integra.GoodRecvNote" %>
      ...
      <table>
        ...
        <tr>
            ...
            <div style=" margin-left: 16px;">
                <telerik:RadButton ID="btnExcel" runat="server" visible="false"  Text="Download Excel" Skin="WebBlue">
                </telerik:RadButton></div>
            </td>
        </tr>
    </table>
