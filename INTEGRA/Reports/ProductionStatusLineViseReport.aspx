<%@ Page Title="Production Status Line Vise Report" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="ProductionStatusLineViseReport.aspx.vb" Inherits="Integra.ProductionStatusLineViseReport" %>
     ...
     <table>
      <tr>
            <th colspan="6" align="left" style="font-family: 'Times New Roman', Times, serif;
                ...
                bgcolor="Silver">
                Production Status Line Wise Report
            </th>
        </tr>
         <%--<tr>
