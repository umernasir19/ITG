<%@ Page Title="Daily Washing OutPut (Item Wash) Report" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="DailyWashingOutPutItemWashReport.aspx.vb" Inherits="Integra.DailyWashingOutPutItemWashReport" %>
    ...
    <table>
        <tr>
            <th colspan="6" align="left" style="font-family: 'Times New Roman', Times, serif;
                ...
                bgcolor="Silver">
                Daily Washing OutPut (Item Wash) Report
            </th>
        </tr>
               <%-- <tr>
