<%@ Page Title="Store Issue Report" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="ProcessStoreIssueReport.aspx.vb" Inherits="Integra.ProcessStoreIssueReport" %>
          ...
          <td style="height: 35px">
            ...
            <td style="height: 35px">
                <div class="text_box" style="width: 130px; margin-left: 0px;">
                    <asp:DropDownList ID="cmbManualChallanNo" runat="server" AutoPostBack="false" CssClass="combo"
        ...
        <tr>
            ...
            <div style="     margin-bottom: 7px;">
             <asp:TextBox ID="TXTCodeEntry" AutoPostBack ="true" style=" width: 127px;"  CssClass="textbox" runat="server"></asp:TextBox>
                            ...
                            CompletionInterval="10" EnableCaching="true" CompletionSetCount="12" ContextKey="TXTCodeEntryForProcessIssueReport" />
       </div>     </td>
         ...
         <td style="height: 35px">
            ...
            <td style="height: 35px">
                <div class="text_box" style="width: 130px; margin-left: 11px;     margin-top: -6px;">
