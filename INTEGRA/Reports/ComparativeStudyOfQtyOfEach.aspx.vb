...
Public Class ComparativeStudyOfQtyOfEach
    ...
    Sub GetDataForReport()
        ...
        Dim RYear As String = cmbyear.SelectedItem.Text
        Dim dtSupplier As DataTable = ObjComparativeStudyofEachOrder.GetVender2(RYear, cmbCustomer.SelectedValue, cmbDept.SelectedItem.Text)
        ...
        For i = 0 To dtSupplier.Rows.Count - 1
            ...
            dt1 = ObjComparativeStudyofEachOrder.getdataforReport1New(SupplierId, "0", "250", RYear, cmbCustomer.SelectedValue, cmbDept.SelectedItem.Text)
            dt2 = ObjComparativeStudyofEachOrder.getdataforReport1New(SupplierId, "250", "500", RYear, cmbCustomer.SelectedValue, cmbDept.SelectedItem.Text)
            dt3 = ObjComparativeStudyofEachOrder.getdataforReport1New(SupplierId, "501", "1000", RYear, cmbCustomer.SelectedValue, cmbDept.SelectedItem.Text)
            dt4 = ObjComparativeStudyofEachOrder.getdataforReport1New(SupplierId, "1001", "1500", RYear, cmbCustomer.SelectedValue, cmbDept.SelectedItem.Text)
            dt5 = ObjComparativeStudyofEachOrder.getdataforReport1New(SupplierId, "1501", "2000", RYear, cmbCustomer.SelectedValue, cmbDept.SelectedItem.Text)
            dt6 = ObjComparativeStudyofEachOrder.getdataforReport1New(SupplierId, "2001", "2500", RYear, cmbCustomer.SelectedValue, cmbDept.SelectedItem.Text)
            dt7 = ObjComparativeStudyofEachOrder.getdataforReport1New(SupplierId, "2501", "3000", RYear, cmbCustomer.SelectedValue, cmbDept.SelectedItem.Text)
            dt8 = ObjComparativeStudyofEachOrder.getdataforReport1New(SupplierId, "3001", "3500", RYear, cmbCustomer.SelectedValue, cmbDept.SelectedItem.Text)
            dt9 = ObjComparativeStudyofEachOrder.getdataforReport1New(SupplierId, "3501", "4000", RYear, cmbCustomer.SelectedValue, cmbDept.SelectedItem.Text)
            dt10 = ObjComparativeStudyofEachOrder.getdataforReport1New(SupplierId, "4001", "4500", RYear, cmbCustomer.SelectedValue, cmbDept.SelectedItem.Text)
            dt11 = ObjComparativeStudyofEachOrder.getdataforReport1New(SupplierId, "4501", "5000", RYear, cmbCustomer.SelectedValue, cmbDept.SelectedItem.Text)
            dt12 = ObjComparativeStudyofEachOrder.getdataforReport1New(SupplierId, "5000", "5500", RYear, cmbCustomer.SelectedValue, cmbDept.SelectedItem.Text)
            dt13 = ObjComparativeStudyofEachOrder.getdataforReport1New(SupplierId, "5501", "7000", RYear, cmbCustomer.SelectedValue, cmbDept.SelectedItem.Text)
            dt14 = ObjComparativeStudyofEachOrder.getdataforReport1New(SupplierId, "7000", "19160", RYear, cmbCustomer.SelectedValue, cmbDept.SelectedItem.Text)
            Dr = dtFinal.NewRow()
            Dr("TempId") = 0
    ...
    Protected Sub btnReport_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnReport.Click
        Try
            ...
            Report.Load(Server.MapPath("..\Reports/OracleEndofYearReport1.rpt"))
            Report.Refresh()
            Dim di As DirectoryInfo = New DirectoryInfo(Server.MapPath("~/TempPDF"))
            di.Create()
            Dim FileName As String = "ComparativeStudyofQuantitiesofEachOrder"
