...
Public Class DailyWashingRecvandIssueRpt
    ...
    Protected Sub btnReport_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnReport.Click
        Try
            ...
            Else
                ...
                Report.Load(Server.MapPath("..\Reports/DailyWashingRecvandIssueReport.rpt"))
                Report.Refresh()
                Dim di As DirectoryInfo = New DirectoryInfo(Server.MapPath("~/TempPDF"))
                di.Create()
                Dim FileName As String = "Daily_Washing_Recv_and_Issue_Report"
