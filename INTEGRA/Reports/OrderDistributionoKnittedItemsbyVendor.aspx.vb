...
Public Class OrderDistributionoKnittedItemsbyVendor
    ...
    Sub BindCustomer()
        ...
        dtt = ObjTempOrderDisKnittedItemsbyVendor.GetCustomerForRpt
        ...
        Dim dt As DataTable
        dt = ObjTempOrderDisKnittedItemsbyVendor.GetDeptCustomerWise(cmbCustomer.SelectedValue)
    ...
    Sub BindDept(ByVal CustomerID As Long)
        Dim dt As DataTable
        dt = ObjTempOrderDisKnittedItemsbyVendor.GetDeptCustomerWise(CustomerID)
        cmbDept.DataSource = dt
        cmbDept.DataTextField = "BuyingDept"
        cmbDept.DataBind()
        cmbDept.Items.Insert(0, New ListItem("All", "0"))
    ...
    Sub GetDataForReport()
        ObjTempOrderDisKnittedItemsbyVendor.TruncateTable()
        Dim dtSupplier As DataTable = ObjTempOrderDisKnittedItemsbyVendor.GetVenderNew(cmbCustomer.SelectedValue, cmbDept.SelectedItem.Text)
        ...
        For i = 0 To dtSupplier.Rows.Count - 1
            ...
            dtyear1 = ObjTempOrderDisKnittedItemsbyVendor.getdataforReport1New("2014", SupplierId, cmbCustomer.SelectedValue, cmbDept.SelectedItem.Text)
            dtyear2 = ObjTempOrderDisKnittedItemsbyVendor.getdataforReport1New("2015", SupplierId, cmbCustomer.SelectedValue, cmbDept.SelectedItem.Text)
            dtyear3 = ObjTempOrderDisKnittedItemsbyVendor.getdataforReport1NewMonthWise("2016", SupplierId, cmbCustomer.SelectedValue, cmbDept.SelectedItem.Text, cmbFromMonth.SelectedValue, cmbToMonth.SelectedValue)
            Dr = dtFinal.NewRow()
            Dr("TempId") = 0
        ...
        For A As Integer = 0 To dtFinal.Rows.Count - 1
            With ObjTempOrderDisKnittedItemsbyVendor
                .TempId = 0
    ...
    Protected Sub btnReport_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnReport.Click
        Try
            ...
            Report.Load(Server.MapPath("..\Reports/OracleEndofYearReport2.rpt"))
            Report.Refresh()
            Dim di As DirectoryInfo = New DirectoryInfo(Server.MapPath("~/TempPDF"))
            di.Create()
            Dim FileName As String = "OrderDisofKnittedItemsbyVendor"
