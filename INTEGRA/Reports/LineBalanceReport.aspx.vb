...
Public Class LineBalanceReport
    ...
    Protected Sub btnReport_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnReport.Click
        Try
            ...
            objSizeRange.temlineBalanceTbaleTruncate()
            ...
            Else
                ...
                Report.Load(Server.MapPath("..\Reports/LineBlanceReportSubReport.rpt"))
                Report.Refresh()
                Dim di As DirectoryInfo = New DirectoryInfo(Server.MapPath("~/TempPDF"))
                di.Create()
                Dim FileName As String = "Line_Balance_Report"
                ...
                If cmbSrNoo.CheckedItems(0).Value = 0 Then
                    ...
                    Report.SetParameterValue(3, txtDate.SelectedDate)
                    Report.SetParameterValue(4, cmbSeason.SelectedValue)
                    Report.SetParameterValue(5, 0)
                Else

                    Dim xx As Integer
                    For xx = 0 To cmbSrNoo.CheckedItems.Count - 1
                        With objTempLineBalance
                            .ID = 0
                    ...
                    Report.SetParameterValue(0, txtDate.SelectedDate)
                    Report.SetParameterValue(1, cmbSeason.SelectedValue)
                    Report.SetParameterValue(2, 1)
                    Report.SetParameterValue(3, txtDate.SelectedDate)
                    Report.SetParameterValue(4, cmbSeason.SelectedValue)
                    Report.SetParameterValue(5, 1)
                End If
