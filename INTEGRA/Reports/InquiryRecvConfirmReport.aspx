<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeBehind="InquiryRecvConfirmReport.aspx.vb" Inherits="Integra.InquiryRecvConfirmReport" %>
...
<table width="100%">
        ...
        <tr style="height: 35px;">
            ...
            <td>
                <asp:DropDownList ID="cmbBuyingDept" runat="server" Width="140px">
                </asp:DropDownList>
            </td>
        </tr>
        <tr style="height: 35px;">
        ...
        <tr style="height: 35px;">
            ...
            <td>
                <asp:DropDownList ID="cmbYear" runat="server" Width="140px">
                    ...
                    <asp:ListItem Value="05">2016</asp:ListItem>
