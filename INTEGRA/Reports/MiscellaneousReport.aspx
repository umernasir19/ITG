<%@ Page Language="vb" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeBehind="MiscellaneousReport.aspx.vb" Inherits="Integra.MiscellaneousReport" %>
...
<asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
 ...
 <telerik:RadComboBoxItem Value="0" Text="Select Report" />
  <telerik:RadComboBoxItem Value="1" Text="Composition Analysis" />
 ...
 <telerik:RadComboBoxItem Value="4" Text="YTD Report" />
 </Items>
 </telerik:RadComboBox> 
     </ContentTemplate>
 </asp:UpdatePanel>
