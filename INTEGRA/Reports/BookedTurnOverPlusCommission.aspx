<%@ Page Language="vb" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeBehind="BookedTurnOverPlusCommission.aspx.vb" Inherits="Integra.BookedTurnOverPlusCommission" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <ContentTemplate>
                        <telerik:RadComboBox ID="cmbreporttype" runat="server" AutoPostBack="True" Skin="WebBlue">
                            <Items>
                                ...
                                <%-- <telerik:RadComboBoxItem Value="6" Text="Season Vise" /> --%>
                            </Items>
                        </telerik:RadComboBox>
                    </ContentTemplate>
                </asp:UpdatePanel>
    ...
    <table>
        <tr>
            ...
            <td class="labelNew">
                <b>*: Dates range should be PO shipment date.</b>
            </td>
        </tr>
    </table>
</asp:Content>
