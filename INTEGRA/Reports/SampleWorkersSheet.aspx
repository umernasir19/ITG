<%@ Page Title="Sample Workers Sheet" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.master"
    CodeBehind="SampleWorkersSheet.aspx.vb" Inherits="Integra.SampleWorkersSheet" %>
    ...
    <table>
        ...
        <tr>
            ...
            <td class="TopHeaderTable3" style="width: 166px; height: 30px;">
                <telerik:RadComboBox ID="cmbWorkerName" runat="server" AutoPostBack="false" Skin="WebBlue">
                </telerik:RadComboBox>
            </td>
        </tr>
        <tr>
