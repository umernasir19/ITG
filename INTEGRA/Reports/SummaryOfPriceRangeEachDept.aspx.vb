...
Public Class SummaryOfPriceRangeEachDept
    ...
    Sub Bindsaeson()
        Dim dt As DataTable
        dt = objPurchaseMaster.GetSeasonForRpt
        cmbseason1.DataSource = dt
        cmbseason1.DataTextField = "Season"
        cmbseason1.DataBind()

        cmbseason2.DataSource = dt
        cmbseason2.DataTextField = "Season"
        cmbseason2.DataBind()

        cmbseason3.DataSource = dt
        cmbseason3.DataTextField = "Season"
        cmbseason3.DataBind()

        cmbseason4.DataSource = dt
        cmbseason4.DataTextField = "Season"
        cmbseason4.DataBind()
    ...
    Protected Sub btnReport_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnReport.Click
        Try
            ...
            Report.Load(Server.MapPath("..\Reports/SummaryofPriceRangeOfstyleeachDeptNew.rpt"))
            Report.Refresh()
            Dim di As DirectoryInfo = New DirectoryInfo(Server.MapPath("~/TempPDF"))
            di.Create()
            Dim FileName As String = "SummaryofPriceRange"
            ...
            Report.SetParameterValue(2, cmbseason1.SelectedItem.Text)
            Report.SetParameterValue(3, cmbseason2.SelectedItem.Text)
            Report.SetParameterValue(4, cmbseason3.SelectedItem.Text)
            Report.SetParameterValue(5, cmbseason4.SelectedItem.Text)
