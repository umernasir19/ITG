<%@ Page Language="vb" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeBehind="ShippedTurnOverPlusCommission.aspx.vb" Inherits="Integra.ShippedTurnOverPlusCommission" %>
  ...
  <telerik:RadComboBoxItem Value="1" Text="Customer Vise" />
   <telerik:RadComboBoxItem Value="2" Text="Supplier Vise" />
    <telerik:RadComboBoxItem Value="3" Text="Merchandiser Vise" />
     <telerik:RadComboBoxItem Value="4" Text="Dept. Vise" />
   <telerik:RadComboBoxItem Value="5" Text="Department Vise" />
<%-- <telerik:RadComboBoxItem Value="6" Text="ECP Vise" />--%>
 </Items>
 </telerik:RadComboBox> 
     </ContentTemplate>
 </asp:UpdatePanel>
...
<td  >
  ...
  </telerik:RadButton></td><td></td><td></td>
  <td  >
  <telerik:RadButton ID="btnReportBuyerSuplier" runat="server" Text="Get Customer Supplier Report" Skin="WebBlue"  >
...
<td class="labelNew" >
<b>
*: Dates range should be ETD shipment date.</b>
</td>
</tr>
</table>
</asp:Content> 